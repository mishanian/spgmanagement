...
<body>
  ...
  <form method="post" class="form-horizontal" action="checkout.php">
    ...
    ?>
      ...
      ?>
        ...
        // Sale payments
        elseif (isset($_POST["saleItem_payment"])) {
          $dataPostValues = $_POST;
          $outstanding  =  round($dataPostValues["item_sale_amt"], 2);
          foreach ($dataPostValues as $nameKey => $value) { ?>
            <input type="hidden" name="<?php echo $nameKey; ?>" value="<?php echo $value; ?>">
          <?php
          }
          ?>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12">
                <p>You are going to pay for the Purchase of <?php echo $dataPostValues["item_name"]; ?></p>
                <br><br>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-2 col-md-2 col-lg-2">Item Detail</div>
              <div class="col-sm-10 col-md-10 col-lg-10">
                <strong><?php echo $dataPostValues["item_detail"];  ?></strong><br><br>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-2 col-md-2 col-lg-2">Item Sale Date:</div>
              <div class="col-sm-10 col-md-10 col-lg-10">
                <strong><?php echo $dataPostValues["item_sale_date"];  ?></strong><br><br>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-2 col-md-2 col-lg-2">Item Sale Amount:</div>
              <div class="col-sm-10 col-md-10 col-lg-10">
                <strong>$<?php echo $dataPostValues["item_sale_amt"];  ?></strong><br><br>
              </div>
            </div>
          </div>
          ...
          # -------------------------  LEASE PAYMENT  --------------------------------
          if (!isset($_POST['id'])) {
            echo "Could not process your request. Please try again.";
            exit;
          }
          $leasePaymentIds = $_POST['id'];
          if (is_array($leasePaymentIds)) {
            // Multiple lease payment ID's are sent
            $lease_payment_id = $leasePaymentIds[0];
            foreach ($leasePaymentIds as $leasePaymentIdSingle) {
          ?>
              <input type="hidden" name="selected_lease_payment_ids[]" id="lease_payment_id" value="<?= $leasePaymentIdSingle ?>">
            <?php
            }
          } else {
            $lease_payment_id = $_POST['id'];
            ?>
            <input type="hidden" name="selected_lease_payment_ids[]" id="lease_payment_id" value="<?= $lease_payment_id ?>">
          <?php
          }

          $rental_payment_info = $DB_payment->get_rental_payment_by_lease_payment_id($lease_payment_id);
          $lease_id = $rental_payment_info["lease_id"];
          ...
          $user_id = $_SESSION['UserID'];
          ?>
          <input type="hidden" name="lease_id" id="product" value="<?php echo $lease_id; ?>">
          ...
          <div class="row">
            ...
            <div class="col-sm-2 col-md-2 col-lg-2 vcenter"><b id="o_1"><?= number_format($outstanding + round($outstanding * $CF_PP_Balance_P / 100, 2), 2) ?></b>
              $ CAD <input type="hidden" name="outstanding1" value="<?= $outstanding + round($outstanding * $CF_PP_Balance_P / 100, 2) ?>"> </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-2 col-md-2 col-lg-2 vcenter"><?php echo number_format($CF_PP_CC_P, 2); ?>%
            </div>
            <div class="col-sm-2 col-md-2 col-lg-2 vcenter"><b id="o_2"><?= number_format($outstanding + round($outstanding * $CF_PP_CC_P / 100, 2), 2) ?></b> $
              CAD <input type="hidden" name="outstanding2" value="<?= $outstanding + round($outstanding * $CF_PP_CC_P / 100, 2) ?>"> </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-2 col-md-2 col-lg-2 vcenter"><b id="o_3"><?= number_format($outstanding + round($outstanding * $CF_M_CC_P / 100, 2), 2) ?></b> $
              CAD</div> <input type="hidden" name="outstanding3" value="<?= $outstanding + round($outstanding * $CF_M_CC_P / 100, 2) ?>">
            <div class="col-sm-5 col-md-5 col-lg-5"> <img src="../phpimages/visa64.png"> <img src="../phpimages/mastercard64.png"></div>
          </div>
          <div class="row">
            <div class="col-sm-3 col-md-3 col-lg-3 vcenter"><input type="radio" name="gateway" id="gateway4" value="m2" required> INTERAC<sup>®</sup> Online Service<br>® Trade-mark of Interac
              Inc.<br> Used under licence.<a href="http://interac.ca/en/interac-online-consumer" target="_blank">Learn more</a></div>
            <div class="col-sm-2 col-md-2 col-lg-2 vcenter"><?php echo number_format($CF_M_Interac_F, 2); ?>$
            </div>
            <div class="col-sm-2 col-md-2 col-lg-2 vcenter"><b id="o_4"><?= number_format(round($outstanding + $CF_M_Interac_F, 2), 2) ?></b> $ CAD <input type="hidden" name="outstanding4" value="<?= round($outstanding + $CF_M_Interac_F, 2) ?>">
            </div>
  ...
  <footer class="main-footer" style="border-top:1px solid #eeeeee; margin-top: 20px;">
    <div class="col-md-12 col-sm-12" style="margin-top: 10px;">
      ...
      <div class="ewFooterText">©2019 SPGManagement</a>, All rights reserved. - <a href="../contact_us.php" target="_blank">Contact Us</a> - <a href="../terms.php" target="_blank">Terms of Service</a></div>
    </div>
  </footer>
