...
<div id="container">
    <div class="col-xs-12 col-md-4 report-btn" style="margin-left: 0px;">
        <button id="startReport" class="btn btn-primary <?php echo $allow_create_request == 0 ? 'remove-for-tenant' : ''; ?>" data-toggle="modal" data-target="#reportModal"> <i class="fas fa-plus"></i>
            <?php echo $DB_snapshot->echot("New Task"); ?></button>
        <button id="startBulletin" class="btn btn-primary remove-for-tenant" data-toggle="modal" data-target="#newBulletinModal"><i class="fas fa-plus"></i>
            <?php echo $DB_snapshot->echot("Notification"); ?></button>
        <a href="office-create-event.php?event_category=office"><button id="newAgenda" class="btn btn-primary remove-for-tenant"><i class="fas fa-plus"></i>
    ...
    <div class="hidden-xs col-md-2">
        <div class="box-text"><span id="open_issue_count"><?php echo $DB_snapshot->echot("OPEN REQUESTS"); ?>:
                <?= $open_issue_counter ?></span><br><?php echo $DB_snapshot->echot("UNREAD"); ?>:<span id="unread_issue_count"><?= $unread_issue_count ?></span></div>
    </div>

    <div class="col-md-12" style="padding-top: 20px;">
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a id="current_issues_a" href="#current-issues" aria-controls="current-issues" role="tab" data-toggle="tab"><?php echo $DB_snapshot->echot("Current Requests"); ?></a></li>
            <li role="presentation" class=" <?php echo $view_past_request == 0 ? 'remove-for-tenant' : ''; ?> "><a href="#past-issues" aria-controls="past-issues" role="tab" data-toggle="tab"><?php echo $DB_snapshot->echot("Past Requests"); ?></a></li>
            <li role="presentation"><a href="#bulletin" aria-controls="bulletin" role="tab" data-toggle="tab"><?php echo $DB_snapshot->echot("Bulletins"); ?></a></li>
            <li id="fixed_events_tabli" class="hidden" role="presentation"><a href="#fixed_events" aria-controls="fixed_events" role="tab" data-toggle="tab"><?php echo $DB_snapshot->echot("Fixed Events"); ?></a></li>
        </ul>
    </div>
    ...
    <div class="tab-content">
            ...
            <div id="filter-part-current" class="col-sm-12 col-md-12 well" style="padding: 15px 0;">
                ...
                <div class="col-sm-4 col-md-3 filter-block">
                    <div class="form-group">
                        <label for="filter_category_current" class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Category"); ?>:</label>
                        <div class="col-sm-8 col-md-9">
        ...
        <div role="tabpanel" class="tab-pane row <?php echo $view_past_request == 0 ? 'remove-for-tenant' : ''; ?>" id="past-issues">
            <div id="filter-part" class="col-sm-12 col-md-12 remove-for-tenant" style="padding: 15px 0;">
                <div class="col-sm-4 col-md-3 filter-block">
                    <label for="filter_building_past" class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Building"); ?>:</label>
                    <div class="col-sm-8 col-md-9">
        ...
        <div role="tabpanel" class="tab-pane row" id="bulletin">
            <div class="col-sm-12 col-md-12" style="margin-top: 10px;">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-bordered table-fixed" style="background-color: white">
                        <thead>
                            <tr>
                            ...
                            ?>
                                <tr class="bulletins-line" data-toggle="modal" data-target="#iModal_bulletin_details" data-request="<?= $bulletin_id ?>">
                                    ...
                                    <td class="col-md-4 text-center">
                                        <?php if ($is_show) { ?>
                                            <button type="button" class="btn bulletin-close table-button" id="bulletin_close_<?php echo $bulletin_id; ?>">Close</button>
                                        <?php } else {
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 10px 16px">
                ...
                <ul class="nav nav-tabs" role="tablist" style="margin-top: 10px;">
                    <li role="presentation" class="active"><a id="communication_tag" href="#communication" aria-controls="communication" role="tab" data-toggle="tab"><?php echo $DB_snapshot->echot("Communications"); ?></a></li>
                    ...
                    <li role="presentation"><a id="edit_tag" href="#edit" aria-controls="edit" role="tab" data-toggle="tab"><?php echo $DB_snapshot->echot("Editing"); ?></a></li>
                                ...
                                <form id="editRecipient">
                                    <div class="row">
                                        <div class="col-sm-12" id="recipient-employee-wrap">
                                            <div class="form-group">
                                                <label class="edit-label col-sm-4"><?php echo $DB_snapshot->echot("Employee"); ?></label>
                                                <div class="col-sm-7">
                                        ...
                                        <div class="col-sm-12 request-notify-me-wrap">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8 col-md-8">
                                                    <label class="checkbox-inline"><input type="hidden" name="notifyMeByEmail" value="0"><input class="edit-input notify-me-by-email" type="checkbox" name="notifyMeByEmail" id="editNotifyMeEmail" value="1"><?php echo $DB_snapshot->echot("Email"); ?></label>
                                                    <label class="checkbox-inline"><input type="hidden" name="notifyMeBySms" value="0"><input class="edit-input notify-me-by-sms" type="checkbox" name="notifyMeBySms" id="editNotifyMeSms" value="1"><?php echo $DB_snapshot->echot("SMS"); ?></label>
                                                    <label class="checkbox-inline"><input type="hidden" name="notifyMeByVoice" value="0"><input class="edit-input notify-me-by-voice" type="checkbox" name="notifyMeByVoice" id="editNotifyMeVoice" value="1"><?php echo $DB_snapshot->echot("Voice"); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 request-payperhr-wrap">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-md-8 request-paymentperhr-div">
                                                <input name="request_pay_perhr" class="form-control" id="request_pay_perhr" name="" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs" role="tablist" style="margin-top: 10px;">
                    <li role="presentation" class="active"><a id="report_details_tag" href="#report_details" aria-controls="report_details" role="tab" data-toggle="tab"><?php echo $DB_snapshot->echot("Details"); ?></a></li>
                    <li role="presentation"><a id="recipient_report_tag" href="#recipient_report" aria-controls="recipient_report" role="tab" data-toggle="tab"><?php echo $DB_snapshot->echot("Recipients"); ?></a></li>
                </ul>
                                ...
                                <form id="reportIssue" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12" id="requestTypeWrap">
                                            <div class="form-group">
                                                <label class="edit-label col-sm-4 col-md-3"><?php echo $DB_snapshot->echot("Reserve Handyman"); ?></label>
                                                <div class="col-sm-8 col-md-8">
                                                    <label class="radio-inline">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 request-visit-time-wraps">
                                            <div class="form-group">
                                                <label class="edit-label col-sm-4 col-md-3" for="handyman_avail_date"><?php echo $DB_snapshot->echot("Visit Time"); ?></label>
                                                <div class="col-sm-8 col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 request-visit-time-wraps" id="visitFromWrap">
                                            <div class="form-group">
                                                <label class="edit-label col-sm-4 col-md-3" for="visitFrom"><?php echo $DB_snapshot->echot("Visit Time"); ?></label>
                                                <div class="col-sm-8 col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <div class="col-sm-8 col-sm-offset-4">
                                                    <button type="button" class="btn btn-primary" id="submitReport"><?php echo $DB_snapshot->echot("Report this request"); ?></button>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs" role="tablist" style="margin-top: 10px;">
                    <li role="presentation" class="active"><a id="bulletin_content_tag" href="#bulletin_content" role="tab" aria-controls="bulletin_content" data-toggle="tab"><?php echo $DB_snapshot->echot("Details"); ?></a></li>
                    <li role="presentation" class="remove-for-tenant"><a id="bullentin_read_status_tag" href="#bulletin_read_status" role="tab" data-toggle="tab"><?php echo $DB_snapshot->echot("Read Tenants"); ?></a></li>
                </ul>
                    ...
                    <div class="form">
                        <form id="bulletinForm">
                            ...
                            <div class="row">
                                <div class="col-sm-12 form-group">
                                    <div class="col-sm-8 col-sm-offset-4">
                                        <button type="submit" class="btn btn-primary" id="submitNewBulletin"><?php echo $DB_snapshot->echot("Submit"); ?></button>
                                        <button class="btn btn-default" data-dismiss="modal"><?php echo $DB_snapshot->echot("Cancel"); ?></button>
                                    </div>
                                </div>
                            </div>
