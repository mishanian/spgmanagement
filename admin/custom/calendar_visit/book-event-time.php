                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Book an Event</li>
                        </ol>
            ...
            <div class="row">
                    ...
                    <div id="content-area" class="contact-area">
                        <div class="white-block">
                            <div class="row">
                                ...
                                <?php
                require('action_event.php');
                $action_event = new action_event();
                $event_id = $_GET['event_id'];
                $book_event_date = $_GET['date'];

                $result = $action_event->get_event($event_id);
                                ...
                                <form id="create-event-oneonone-form" action="controller_event.php" method="post">
                                    ...
                                    <div class="col-sm-12 col-xs-12 contact-block-inner">
                                        <div class="form-group create-event-form-col-1">
                                            <label class="control-label">Event Name: <?php echo $event_name ?></label>
                                        </div>
                                        <div class="form-group create-event-form-col-1">
                                            <label class="control-label">Duration: <?php echo $event_duration ?>
                                                min</label>
                                        </div>
                                        <div class="form-group create-event-form-col-2">
                                            <label class="control-label">Date: <?php echo $book_event_date ?></label>
                                        </div>
                                    </div>
                                </form>
                                <?php
                ...
                ?>
                                ...
                                <form id="add-event-oneonone-availability-form" action="controller_event.php"
                                    method="post">
                                    <input type="hidden" name="event_id" value="<?php echo $event_id; ?>" />
                                    <input type="hidden" name="book_event_date"
                                        value="<?php echo $book_event_date; ?>" />
                                    <legend>Choose Start Time</legend>
                                    <?php
                  require('action_booking.php');
                  $action_booking = new action_booking();

                  $result = $action_booking->get_bookings($event_id, $book_event_date);

                  if (mysqli_num_rows($result) < $event_max_book_per_day) {
                  ?>
                                    <div class="form-group book-event-col-3">
                                        <div class="book-event-col-1">
                                            <select name="book_event_time" class="form-control" type="text"
                                                autocomplete="off">
                          ...
                          ?>
                                                <option value="<?php echo $time_slots[$i]; ?>"><?php echo $text; ?>
                                                </option>
                                                <?php
                          }
                          ?>
                                        ...
                                        <div class="book-event-col-2">
                                            <button type="submit" class="btn btn-secondary event-form-button"
                                                name="book_event_choose_time">Confirm & Book</button>
                                            <button type="submit" class="btn btn-secondary event-form-button"
                                                name="book_event_back">Back</button>
                                        </div>
                                    </div>
                                    <?php
                  } else {
