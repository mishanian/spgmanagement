...
<body>
    <div class="container" style="margin: 30px 30px">
        ...
        <?php if ($fail_source == 'moneris') { ?>
            ...
            <div class="col-sm-10 col-md-10 col-sm-offset-1 col-md-offset-1" style="border: 1px solid #eeeeee;border-radius: 4px; padding: 10px 5px">
        ...
        <div class="col-sm-1 col-md-1 col-sm-offset-2 col-md-offset-2 <?php if ($fail_source == 'paypal') echo 'non-display'; ?>" style="margin-top: 20px;">
