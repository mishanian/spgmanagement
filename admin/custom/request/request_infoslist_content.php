...
<div id="container" style="margin-top: 10px;">
    ...
    <input type="hidden" id="if_vendor_id_set" name="if_vendor_id_set" value="<?php echo (isset($vendorId)) ? $vendorId : -1; ?>">
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            <ul class="nav">
                ...
                ?>
                    <li class="nav-item">
                        <button id="startBulletin" style="<?php echo $displayNewRequestNotifButtons; ?>" class="nav-link btn-primary" data-toggle="modal" data-target="#newBulletinModal">
    ...
    <div class="col-md-12 form-group" style="padding-top: 20px;background: aliceblue;">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" id="current_issues_a" href="#current-issues"><?php echo $DB_snapshot->echot("Current Requests"); ?></a>
            </li>

            <li id="past_issues_tabli" class="nav-item <?php echo $view_past_request == 0 ? 'remove-for-tenant' : ''; ?> ">
                <a class="nav-link " data-toggle="tab" href="#past-issues" aria-controls="past-issues"><?php echo $DB_snapshot->echot("Past Requests"); ?></a>
            </li>

            <?php if ($user_level != 5) { ?>
                <li class="nav-item"><a class="nav-link" data-toggle="tab" id="all_issues_a" href="#all-issues" aria-controls="all-issues" data-toggle="tab"><?php echo $DB_snapshot->echot("All Requests"); ?></a>
                </li>
            <?php } ?>

            <li class="nav-item" id="bulletins_tabli"><a class="nav-link" data-toggle="tab" href="#bulletin" aria-controls="bulletin" data-toggle="tab"><?php echo $DB_snapshot->echot("Bulletins"); ?></a>
            </li>

            <?php if ($user_level != 5) { ?>
                <li id="fixed_events_tabli" role="presentation"><a class="nav-link" data-toggle="tab" href="#fixed_events" aria-controls="fixed_events" data-toggle="tab"><?php echo $DB_snapshot->echot("Fixed Events"); ?></a>
                </li>
            <?php } ?>

            <?php if ($user_level == 23 || $user_level == 24) { ?>
                <li class="nav-item" id="projects_tabli" role="presentation"><a class="nav-link" data-toggle="tab" href="#projects_table" aria-controls="projects_table" data-toggle="tab"><?php echo $DB_snapshot->echot("Projects"); ?></a>
                <?php } ?>
                </li>
                <li class="nav-item" id="projects_requests_tabli" role="presentation"><a class="nav-link" style="display:none;" id="projects_requests_tabli_a" href="#projects_requests_table" aria-controls="projects_requests_table" data-toggle="tab"><?php echo $DB_snapshot->echot("Vendor Requests"); ?></a>
                </li>
        </ul>
    </div>
        ...
        <div role="tabpanel" class="tab-pane active row" id="current-issues">
            <div id="filter-part-current" class="col-sm-12 col-md-12 card card-body bg-light">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#filter-part-current-displaycollapse" aria-expanded="false" aria-controls="filter-part-current-displaycollapse"><i class="fas fa-plus"></i> List
                            Filters
                        </button>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-md-9">
                                    <input type="text" class="form-control date_input" id="filter_created_from_current" style="min-width: 0;" placeholder="YYYY-MM-DD">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-md-9">
                                    <input type="text" class="form-control date_input" id="filter_created_to_current" style="min-width: 0;" placeholder="YYYY-MM-DD">
                                </div>
                            </div>
                        </div>
                        ...
                        <tbody id="current_issue_tbody">
                            ...
                            ?>
                                <tr style="border-bottom:1px solid #D0D0D0; background-color: <?= $readColor ?> " class="<?php //echo $style_class . ' ' . $status_txt_class;
                                    ...
                                    <td class="text-center non-overflow" data-toggle="tooltip" data-container="body" title="<?php echo $message; ?>"><?php echo $message; ?></td>
                                    <td class="text-center non-overflow" data-container="body" data-caption="<?php echo $address; ?>"><?php echo $address; ?></td>
                                    ...
                                    <td class="text-center non-overflow" data-toggle="tooltip" data-container="body" <?php if ($created_user_info['full_name'] != "SYSTEM") echo 'title="' . ' Telephone :' . $created_user_info['mobile'] . 'Email :' . $created_user_info['email'] . '"'; ?>>
                                        <?php echo $created_user_info['full_name']; ?></td>
                                    <td class="text-center non-overflow" data-toggle="tooltip" data-container="body" title="<?php echo $closed_by_user_name; ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-md-9">
                                    <input type="text" class="form-control date_input" id="filter_created_from_past" style="min-width: 0;" placeholder="YYYY-MM-DD">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-md-9">
                                    <input type="text" class="form-control date_input" id="filter_created_to_past" style="min-width: 0;" placeholder="YYYY-MM-DD">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-md-9">
                                    <input type="text" class="form-control date_input" id="filter_created_from_allissues" style="min-width: 0;" placeholder="YYYY-MM-DD">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-md-9">
                                    <input type="text" class="form-control date_input" id="filter_created_to_allissues" style="min-width: 0;" placeholder="YYYY-MM-DD">
                                </div>
                            </div>
                        </div>
                            ...
                            ?>
                                <tr style="border-bottom:1px solid #D0D0D0; background-color: <?= $readColor ?> " class="<?php echo $style_class . ' ' . $status_txt_class; ?> issue-line" id="<?php echo 'issue_row_' . $request_id; ?>" data-toggle="" data-target="#iModal" data-request="<?php echo $request_id; ?>">
                                    ...
                                    <td class="col-md-1 text-center non-overflow" data-toggle="tooltip" data-container="body" <?php if ($created_user_info['full_name'] != "SYSTEM") echo 'title="' . ' Telephone :' . $created_user_info['mobile'] . 'Email :' . $created_user_info['email'] . '"'; ?>>
                                        <?php echo $created_user_info['full_name']; ?></td>
                                    <td class="col-md-1 text-center non-overflow" data-toggle="tooltip" data-container="body" title="<?php echo $closed_by_user_name; ?>">
                                        <?php echo $closed_by_user_name; ?></td>
                                    <td class="col-md-1 text-center">
                                        <span data-rid="<?php echo $request_id; ?>" class="btn btn-info rdetails_view"><i class="fas fa-search"></i></span>
                                    </td>
            ...
            <div id="filter-part-fixed" class="col-sm-12 col-md-12 card card-body bg-light" style="padding: 15px 0;">
                <div class="row">
                    <div class="col-sm-2 col-md-8 filter-block">
                        <label for="filter_building_fixed_event" class="mr-sm-2 filter-text"><?php echo $DB_snapshot->echot("Building"); ?></label>
                        <div class="col-sm-8 col-md-9">
                    ...
                    <div class="col-sm-4 col-md-4 filter-block">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-9">
                                <input type="text" class="form-control date_input" id="filter_date_event_fixed" style="min-width: 0;" placeholder="YYYY-MM-DD">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 10px 16px">
                ...
                <ul class="nav nav-tabs" role="tablist" style="margin-top: 10px;">
                    <li role="presentation" class="active"><a id="communication_tag" href="#communication" aria-controls="communication"><?php echo $DB_snapshot->echot("Communications"); ?></a>
                    </li>
                    ...
                    ?>
                    <!--</a></li>-->
                    <li role="presentation"><a id="recipient_tag" href="#recipient" aria-controls="recipient"><?php echo $DB_snapshot->echot("Recipient"); ?></a>
                    </li>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <div class="col-sm-8 col-sm-offset-4">
                                                    ...
                                                    <button id="cancelRecipients" type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo $DB_snapshot->echot("Cancel"); ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <div class="col-sm-8 col-sm-offset-4">
                                                    ...
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal" id="cancelEdit"><?php echo $DB_snapshot->echot("Cancel"); ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-8 col-sm-offset-4">
                                                        ...
                                                        <button class="btn btn-secondary" data-dismiss="modal"><?php echo $DB_snapshot->echot("Cancel"); ?></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
