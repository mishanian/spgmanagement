...
// die("c=".count($raw_current_issues));
...
<div id="container" style="margin-top: 10px;">
    ...
    <input type="hidden" id="if_vendor_id_set" name="if_vendor_id_set"
        value="<?php echo (isset($vendorId)) ? $vendorId : -1; ?>">
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            <ul class="nav">
                ...
                <li class="nav-item dropdown remove-for-tenant">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">Filters
                        <span class="caret"></span></a>
                    <div class="dropdown-menu">

                        <?php /* Show the category projects li only if the user is a manager */
                        if ($user_level == 23 || $user_level == 24) { ?>
                        <a class="dropdown-item">
                            <div data-type="projects" data-title="Projects" class="remove-for-tenant filter_element"
                                style="cursor: pointer;" id="category-projects">
                        ...
                        <a class="dropdown-item">
                            <div data-type="fixed" data-title="Fixed Event" class="remove-for-tenant filter_element"
                                style="cursor: pointer;" id="category-fixed">
                                <div class="category-box category-fixed"></div>
                                <div class="box-text"><?php echo $DB_snapshot->echot("Fixed Event"); ?></div>
                            </div>
                        </a>
                        <a class="dropdown-item">
                            <div data-type="internal" data-title="Internal Request"
                                class="remove-for-tenant filter_element" style="cursor: pointer;"
                        ...
                        <a class="dropdown-item">
                            <div data-type="tenant" data-title="Tenant Request" class="remove-for-tenant filter_element"
                                style="cursor: pointer;" id="category-tenant">
                                <div class="category-box category-tenant"></div>
                                <div class="box-text"><?php echo $DB_snapshot->echot("Tenant Request"); ?></div>
                            </div>
                        </a>
                        <a class="dropdown-item">
                            <div data-type="unread" data-title="Unread Request" class="filter_element"
                                style="cursor: pointer;" id="unread_request_mark">
                                <div class="category-box category-unread"></div>
                                <div class="box-text"><?php echo $DB_snapshot->echot("Unread Request"); ?></div>
                            </div>
                        </a>
                        <a class="dropdown-item">
                            <div data-type="current" data-title="Current Requests" class="filter_element"
                                style="cursor: pointer;" id="current_requests_filter">
                ...
                ?>
                <li class="nav-item">
                    <button id="startBulletin" style="<?php echo $displayNewRequestNotifButtons; ?>"
                        class="nav-link btn-primary" data-toggle="modal" data-target="#newBulletinModal">
    ...
    <div class="col-md-12 form-group" style="padding-top: 20px;background: aliceblue;">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" id="current_issues_a"
            ...
            <?php if ($user_level != 5) { ?>
            <li class="nav-item"><a class="nav-link" data-toggle="tab" id="all_issues_a" href="#all-issues"
                    aria-controls="all-issues" data-toggle="tab"><?php echo $DB_snapshot->echot("All Requests"); ?></a>
            </li>
            <?php } ?>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane active row" id="current-issues">
            <div id="filter-part-current" class="col-sm-12 col-md-12 card card-body bg-light">

                <div class="row form-group">
                    <div class="col-md-8">
                        <input class="form-control" id="filter_general_current"
                            placeholder="Start typing to search the list..">
                    </div>
                    <div class="col-md-4">
                        <button class="btn btn-primary" type="button" data-toggle="collapse"
                            data-target="#filter-part-current-displaycollapse" aria-expanded="false"
                            aria-controls="filter-part-current-displaycollapse"><i class="fas fa-plus"></i> List
                            Filters
                        </button>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                <label for="filter_category_current"
                                    class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Category"); ?>
                                </label>
                                <div class="col-sm-8 col-md-9">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-md-9">
                                    <select class="form-control" name="request_type_detail" id="request_type_detail"
                                        required>
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                <label for="filter_status_current"
                                    class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Status"); ?>
                                </label>
                                <div class="col-sm-8 col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 col-md-9">
                                    <input class="form-control" id="filter_tenant_current"
            ...
            <div id="issue-list" class="col-sm-12 col-md-12">
                ...
                <div class="table-responsive">
                    <table id="currentRequestsTable" class="table table-hover table-bordered table-fixed"
                        style="background-color: white">
                        <thead>
                            <tr>
                                <!-- <td class="text-center"><?php echo $DB_snapshot->echot("ID"); ?></td> -->
                                <td class="text-center"><?php echo $DB_snapshot->echot("CreatedOn"); ?></td>
                                <td class="text-center" style="width: 25%">
                                    <?php echo $DB_snapshot->echot("Description"); ?></td>
                                <td class="text-center"><?php echo $DB_snapshot->echot("Location"); ?></td>
                                <td class="text-center"><?php echo $DB_snapshot->echot("Type"); ?></td>
                                <td class="text-center"><?php echo $DB_snapshot->echot("Status"); ?></td>
                                <td class="text-center"><?php echo $DB_snapshot->echot("Level"); ?></td>
                                <td class="text-center"><?php echo $DB_snapshot->echot("Days Old"); ?></td>
                                <td class="text-center"><?php echo $DB_snapshot->echot("Creator"); ?></td>
                                <td class="text-center"><?php echo $DB_snapshot->echot("ClosedBy"); ?></td>
                                <td class="text-center"><?php echo $DB_snapshot->echot("Details"); ?></td>
                                <?php if ($user_level != 5) { ?>
                                <!-- <td class="text-center"><?php echo $DB_snapshot->echot("Bill"); ?></td> -->
                                <?php } ?>
                                <?php if (isset($is_admin) && $is_admin == 1) { ?>
                                <!-- <td class="text-center"> <?php echo $DB_snapshot->echot("Delete"); ?></td> -->
                                <?php } ?>
                            </tr>
                        </thead>
                        <tbody id="current_issue_tbody">
                            <?php
                            // current issue list
                            // echo "count=".count($raw_current_issues);
                            foreach ($raw_current_issues as $row) {
                                // var_dump($row);
                                // echo $row['id']."-".$row['is_active']."------";
                                ...
                                $message = $row['message'];
                                if (strlen(trim($message)) == 0 || $message == null) {
                                    $message = ' - ';
                                }
                            ...
                            <tr style="border-bottom:1px solid #D0D0D0; background-color: <?= $readColor ?> "
                                class="<?php //echo $style_class . ' ' . $status_txt_class;
                                                                                                                            ?> issue-line" id="<?php echo 'issue_row_' . $request_id; ?>"
                                data-toggle="" data-target="#iModal" data-request="<?php echo $request_id; ?>">
                                <!-- <td data-search="<?php echo $request_id; ?>" class="text-center">
                                    <?php echo $request_id; ?> </td> -->
                                <td class="text-center"><?php echo $created_time; ?> </td>
                                <td class="text-center non-overflow" data-toggle="tooltip" data-container="body"
                                    title="<?php echo $message; ?>"><?php echo $message; ?></td>
                                <td class="text-center non-overflow" data-container="body"
                                    data-caption="<?php echo $address; ?>"><?php echo $address; ?></td>
                                <td class="text-center"><?php echo $request_type ?></td>
                                <td class="text-center"><?php echo strtoupper($request_detailed_name); ?></td>
                                <td class="text-center <?php echo $level_label_class; ?>">
                                    <?php echo $request_level; ?></td>
                                <td class="text-center" data-value="<?php echo $time_interval; ?>">
                                ...
                                <td class="text-center non-overflow" data-toggle="tooltip" data-container="body"
                                    title="<?php echo $closed_by_user_name; ?>">
                                    <?php echo $closed_by_user_name; ?></td>
                                <td class="text-center">
                                    <span data-rid="<?php echo $request_id; ?>" class="btn btn-info rdetails_view"><i
                                            class="fas fa-search"></i></span>
                                </td>

                                <?php if ($user_level != 5) { ?>
                                <!--<td class="text-center non-overflow" data-toggle="tooltip"
                                    data-container="body" title="<?php echo $message; ?>">
                                    <a class="billLinkHref"
                                        href="<?php echo !empty($vendor_id) ? "addBillByRequest.php?request_id=" . $request_id : "addEditBill.php?request_id=" . $request_id; ?>">
        ...
        <div role="tabpanel" class="tab-pane row  <?php echo $view_past_request == 0 ? 'remove-for-tenant' : ''; ?>"
            ...
            <div id="filter-part" class="col-sm-12 col-md-12 remove-for-tenant card card-body bg-light">

                <div class="row form-group">
                    <div class="col-md-8">
                        <input class="form-control" id="filter_general_past"
                            placeholder="Start typing to search the list..">
                    </div>
                    <div class="col-md-4">
                        <button class="btn btn-primary" data-toggle="collapse"
                            data-target="#filter-part-past-displaycollapse"><i class="fas fa-plus"></i> List Filters
                        </button>
                    </div>
                </div>
                ...
                <div class="collapse" id="filter-part-past-displaycollapse">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <label for="filter_building_past"
                                class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Building"); ?>
                            </label>
                            <div class="col-sm-8 col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block col-sm-off-8 col-md-offset-6"
            ...
            <div id="issue-list" class="col-sm-12 col-md-12">
                ...
                <div class="table-responsive">
                    <table id="pastRequestsTable" class="table table-hover table-bordered table-fixed"
                        style="background-color: white">
                        <thead>
                            <tr>
        ...
        <div role="tabpanel" class="tab-pane row" id="all-issues">
            <div id="filter-part-allissues" class="col-sm-12 col-md-12 card card-body bg-light">

                <div class="row form-group">
                    <div class="col-md-8">
                        <input class="form-control" id="filter_general_alisssues"
                            placeholder="Start typing to search the list..">
                    </div>
                    <div class="col-md-4">
                        <button class="btn btn-primary" data-toggle="collapse"
                            data-target="#filter-part-allissues-displaycollapse"><i class="fas fa-plus"></i> List
                            Filters
                        </button>
                    </div>
                </div>
                ...
                <div class="collapse" id="filter-part-allissues-displaycollapse">
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-3 filter-block">
                            <label for="filter_building_allissues"
                                class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Building"); ?></label>
                            <div class="col-sm-8 col-md-9">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                <label for="filter_units_allissues"
                                    class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Units"); ?></label>
                                <div class="col-sm-8 col-md-9">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                <label for="filter_category_allissues"
                                    class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Category"); ?>
                                </label>
                                <div class="col-sm-8 col-md-9">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                <label for="request_type_detail_allissues"
                                    class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Request Type"); ?></label>
                                <div class="col-sm-8 col-md-9">
                                    <select class="form-control" name="request_type_detail_allissues"
                                        id="request_type_detail_allissues" required>
                                        <option value="all">Select Request Type</option>
                                        <?php
                                        $request_types = $DB_request->get_request_types_all();
                                        foreach ($request_types as $singleRequestType) {
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                <label for="filter_status_allissues"
                                    class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Status"); ?>
                                </label>
                                <div class="col-sm-8 col-md-9">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                <label for="filter_created_from_allissues"
                                    class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("From"); ?></label>
                                <div class="col-sm-8 col-md-9">
                                    <input type="text" class="form-control date_input"
                                        id="filter_created_from_allissues" style="min-width: 0;"
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                <label for="filter_created_to_allissues"
                                    class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("To"); ?></label>
                                <div class="col-sm-8 col-md-9">
                                    <input type="text" class="form-control date_input" id="filter_created_to_allissues"
                                        style="min-width: 0;" placeholder="YYYY-MM-DD">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                <label for="filter_employee_allissues"
                                    class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Employee"); ?></label>
                                <div class="col-sm-8 col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                <label for="filter_tenant_allissues"
                                    class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Tenant"); ?></label>
                                <div class="col-sm-8 col-md-9">
                                    <input class="form-control" id="filter_tenant_allissues"
                                        placeholder="Wildcard Search">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 col-md-3 filter-block">
                            <div class="form-group row">
                                <label for="filter_read_category_allissues"
                                    class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Read Category"); ?></label>
                                <div class="col-sm-8 col-md-9">
                        ...
                        <div class="col-sm-4 col-md-3 filter-block " style="padding-top: 5px;float:right">
                            <button class="btn btn-primary col-sm-4 col-md-4 col-sm-offset-2 col-md-offset-2"
                                id="default_allissues"><?php echo $DB_snapshot->echot("Clear"); ?></button>
                            <button class="btn btn-primary col-sm-4 col-md-4 col-sm-offset-1 col-md-offset-1"
                                id="search_allissues"><?php echo $DB_snapshot->echot("Search"); ?></button>
                        </div>
                    </div>
            ...
            <div id="issue-list" class="col-sm-12 col-md-12">
                <div class="table-responsive">
                    <table id="allRequestsTable" class="table table-hover table-bordered table-fixed"
                        style="background-color: white">
                        <thead>
                            <tr>
                        ...
                        <tbody id="all_issue_tbody">
                            ...
                            ?>
                            <tr style="border-bottom:1px solid #D0D0D0; background-color: <?= $readColor ?> "
                                class="<?php echo $style_class . ' ' . $status_txt_class; ?> issue-line"
                                ...
                                <td class="col-md-3 text-center non-overflow" data-toggle="tooltip"
                                    data-container="body" title="<?php echo $message; ?>"><?php echo $message; ?></td>
                                <td class="col-md-2 text-center non-overflow" data-container="body"
                                    data-caption="<?php echo $address; ?>"><?php echo $address; ?></td>
                                <td class="col-md-1 text-center"><?php echo $request_type ?></td>
        ...
        <div role="tabpanel" class="tab-pane row" id="bulletin">
            <div class="col-sm-12 col-md-12" style="margin-top: 10px;">
                ...
                <div class="table-responsive">
                    <table id="bulletinsTable" class="table table-striped table-hover table-bordered table-fixed"
                        style="background-color: white">
                        <thead>
                            <tr>
                        ...
                        <tbody id="bulletins_tbody">
                            ...
                            <tr class="bulletins-line" data-toggle="modal" data-target="#iModal_bulletin_details"
                                ...
                                <td class="col-md-4 text-center non-overflow" data-toggle="tooltip"
                                    data-container="body" title="<?php echo $message_title; ?>">
                                    <?php echo $message_title; ?></td>

                                <?php if ($user_level != 5) { ?>
                                <td class="col-md-4 text-center">
                                    <?php if ($is_show) { ?>
                                    <button type="button" class="btn bulletin-close table-button"
                                        id="bulletin_close_<?php echo $bulletin_id; ?>">Close
                                    </button>
                                    <?php } ?>
                                </td>
                                <?php } ?>
        ...
        <div role="tabpanel" class="tab-pane row" id="fixed_events">
            <div id="filter-part-fixed" class="col-sm-12 col-md-12 card card-body bg-light" style="padding: 15px 0;">
                <div class="row">
                    <div class="col-sm-2 col-md-8 filter-block">
                        <label for="filter_building_fixed_event"
                            class="mr-sm-2 filter-text"><?php echo $DB_snapshot->echot("Building"); ?></label>
                        <div class="col-sm-8 col-md-9">
                    ...
                    <div class="col-sm-4 col-md-4 filter-block">
                        <div class="form-group row">
                            <label for="filter_date_event_fixed"
                                class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Event Date"); ?></label>
                            <div class="col-sm-8 col-md-9">
                                <input type="text" class="form-control date_input" id="filter_date_event_fixed"
                                    style="min-width: 0;" placeholder="YYYY-MM-DD">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-3 col-md-5 filter-block">
                        <div class="form-group row">
                            <label for="filter_category_fixed"
                                class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Category"); ?></label>
                            <div class="col-sm-8 col-md-9">
                    ...
                    <div class="col-sm-4 col-md-5 filter-block">
                        <div class="form-group row">
                            <label for="filter_createdby_fixed"
                                class="col-sm-4 col-md-3 filter-text"><?php echo $DB_snapshot->echot("Created By"); ?></label>
                            <div class="col-sm-8 col-md-9">
                                <select class="form-control" id="filter_createdby_fixed">
                                    ...
                                    ?>
                                    <option value="<?php echo $id; ?>" data-name="<?php echo $name; ?>">
                    ...
                    <div class="col-sm-4 col-md-2 filter-block " style="padding-top: 5px;">
                        <button class="btn btn-primary col-sm-4 col-md-4 col-sm-offset-2 col-md-offset-2"
                            id="default_fixed_event"><?php echo $DB_snapshot->echot("Clear"); ?></button>
                    </div>
                </div>
            </div>
            <!-- filter end-->
            ...
            <div class="col-sm-12 col-md-12" style="margin-top: 10px;">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-condensed card card-body bg-light" id="fixed_events_table">
                        <thead>
                            <tr>
        ...
        <!-- Project and requests card - Show only when coming from vendors page -->
        <div role="tabpanel" class="tab-pane row" id="projects_requests_table">

            <div id="filter-part-projects" class="col-sm-12 col-md-12 card card-body bg-light">

                <div class="row form-group">
                    <div class="col-md-8">
                        <input class="form-control" id="filter_general_vendorrequests"
                            placeholder="Start typing to search the list..">
                    </div>
                    <!--                    <div class="col-md-4">-->
                    <!--                        <button class="btn btn-primary" data-toggle="collapse"-->
            ...
            <div id="issue-list" class="col-sm-12 col-md-12">
                <div class="table-responsive">
                    <table id="projects_requests_table_for_vendor" class="table table-hover table-bordered table-fixed"
                        style="background-color: white">
                        <thead>
                            <tr>
                                <td class="col-md-1 text-center"><?php echo $DB_snapshot->echot("Request ID"); ?></td>
                        ...
                        <tbody id="projects_requests_table_for_vendor_tbody">
                            ...
                            <tr class="<?php echo $style_class . ' ' . $status_txt_class; ?> issue-line"
                                ...
                                <td class="col-md-1 text-center non-overflow" data-toggle="tooltip"
                                    data-container="body" title="<?php echo $closed_by_user_name; ?>">
                                    <?php echo $closed_by_user_name; ?></td>
                                <td class="col-md-1 text-center"><span data-rid="<?php echo $request_id; ?>"
                                        class="btn btn-info rdetails_view"> <i class="fas fa-search"></i> </span></td>
                                <td class="col-md-1 text-center non-overflow" data-toggle="tooltip"
                                    data-container="body" title="<?php echo $message; ?>"><a class="billLinkHref"
                                        href="<?php echo !empty($vendor_id) ? "addBillByRequest.php?request_id=" . $request_id : "addEditBill.php?request_id=" . $request_id; ?>">
                                ...
                                <?php } else {
                                        ?>
                                <td data-rid="<?php echo $request_id; ?>" class="col-md-1 text-center"
                                    onclick="preventDefault();"><i class="fas fa-ban"></i></td>
                                <?php }
                                    } ?>
                            </tr>
                            <?php } ?>
        ...
        <div role="tabpanel" class="tab-pane row" id="projects_table">
            ...
            <div class="data_projects_display">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="table-responsive">
                        <table id="data_projects_table" class="table table-hover table-bordered table-fixed"
                            style="background-color: white">
                            <thead>
                                <tr>
                                    <td class="col-md-2 text-center"><?php echo $DB_snapshot->echot("Project Name"); ?>
                                    </td>
                                    <td class="col-md-1 text-center">
                                        <?php echo $DB_snapshot->echot("No of Contracts"); ?></td>
                                    <td class="col-md-2 text-center"><?php echo $DB_snapshot->echot("Location"); ?></td>
                            ...
                            <tbody id="project_issue_tbody">
                                ...
                                <tr data-target="#iModal" data-projectid="<?php echo $row["project_id"]; ?>"
                                    ...
                                    <td class="col-md-1 text-center non-overflow" data-container="body">
                                        <button id="<?php echo 'showContracts_project_' . $row["project_id"]; ?>"
                                            data-projectid="<?php echo $row["project_id"]; ?>"
                                            class="toggle-contractdisplay btn btn-primary"><i class="fas fa-search"></i>
                                            View Contracts
                                        </button>
                                    </td>
                                    <?php if (isset($is_admin) && $is_admin == 1) { ?>
                                    <td data-projectid="<?php echo $row["project_id"]; ?>" class="col-md-1 text-center">
                                        <button data-projectid="<?php echo $row["project_id"]; ?>"
                                            class="deleteProject btn btn-danger"><i
                                                data-projectid="<?php echo $row["project_id"]; ?>"
                                                class="far fa-trash-alt"></i> Delete Project
                                        </button>
                                    </td>
                                    <?php } ?>
                                </tr>
            ...
            <div class="data_projectcontracts_display" style="display:none;">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="table-responsive">
                        <table id="contractsDisplayTable" class="table table-hover table-bordered"
                            style="background-color: white">
                            <thead>
                                <tr>
                                    ...
                                    <td class="col-md-1 text-center">
                                        <?php echo $DB_snapshot->echot("Contract Price"); ?></td>
                                    <td class="col-md-1 text-center"> <?php echo $DB_snapshot->echot("Delete"); ?></td>
                                    <td class="col-md-1 text-center"> <?php echo $DB_snapshot->echot("Requests"); ?>
                                    </td>
                                </tr>
                            </thead>
            ...
            <div class="data_projectrequests_display" style="display: none;">
                <div class="col-sm-12 col-md-12">
                    <legend><?php echo $DB_snapshot->echot("All Requests"); ?>
                        ...
                        <div style="float:right;">
                            <span class="toggle-contractdisplayFromRequests btn btn-primary"><i
                                    class="fas fa-arrow-left"></i> Show Contracts </span>
                    ...
                    <div class="table-responsive">
                        <table id="data_projectrequests_table" class="table table-hover table-bordered table-fixed"
                            style="background-color: white">
                            <thead>
                                <tr>
                                    ...
                                    <td class="col-md-2 text-center"><?php echo $DB_snapshot->echot("Status"); ?></td>
                                    <td class="col-md-2 text-center"><?php echo $DB_snapshot->echot("Description"); ?>
                                    </td>
                                    <td class="col-md-1 text-center"><?php echo $DB_snapshot->echot("Requests Type"); ?>
                                    </td>
                                    <td class="col-md-1 text-center"><?php echo $DB_snapshot->echot("Level"); ?></td>
                                    <td class="col-md-1 text-center"><?php echo $DB_snapshot->echot("Date Created"); ?>
                                    </td>
                                    <td class="col-md-1 text-center"><?php echo $DB_snapshot->echot("Days Old"); ?></td>
                                    <td class="col-md-1 text-center"><?php echo $DB_snapshot->echot("Creator"); ?></td>
                                    <td class="col-md-1 text-center"><?php echo $DB_snapshot->echot("Closed By"); ?>
                                    </td>
                                    <!-- <td class="col-md-1 text-center"><?php echo $DB_snapshot->echot("Bill"); ?></td> -->
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-status modal-status-open" id="open_or_closed"><span class="main-status"
                        id="open_or_closed_text">OPEN</span>
                </div>
            ...
            <div class="modal-body" style="padding: 10px 16px">
                ...
                <ul class="nav nav-tabs" role="tablest" style="margin-top: 10px;">
                    ...
                    ?>
                    <!--</a></li>-->
                    <li role="presentation"><a id="recipient_tag" href="#recipient"
                            aria-controls="recipient"><?php echo $DB_snapshot->echot("Recipient"); ?></a>
                    </li>
                    <li role="presentation"><a id="edit_tag" href="#edit" aria-controls="edit" role="tab"
                            data-toggle="tab"><?php echo $DB_snapshot->echot("Order"); ?></a></li>
                    ...
                    <li role="presentation"><a class="remove-for-tenant" id="materials_tag" href="#materialedit_tab"
                            aria-controls="materialedit_tab" role="tab"
                            data-toggle="tab"><?php echo $DB_snapshot->echot("Materials"); ?></a>
                    </li>
                    <li role="presentation"><a class="remove-for-tenant" id="invoices_report_tag"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <div class="col-sm-8 col-sm-offset-4">
                                                    ...
                                                    <button id="cancelRecipients" type="button"
                                ...
                                <form id="edit-request">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8 col-md-8">
                                                    ...
                                                    <textarea style="display:none;" class="form-control"
                                                        ...
                                                        placeholder="Specific Common Area (e.g. Elevator No.2)"></textarea>
                                                    <select style="display:none;" class="form-control"
                                                        id="editRequestLocationFloor"
                                                        name="editRequestLocationFloor"></select>
                                                    <select style="display:none;" class="form-control form-group"
                                                        id="editRequestLocationApt"
                                                        name="editRequestLocationApt"></select>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row remove-for-tenant">
                                        <div class="col-sm-12 request-editprojectname-wrap">
                                            <div class="form-group row">
                                                <label class="edit-label col-sm-4 col-md-3"
                                                    for="editRequestProjectName"><?php echo $DB_snapshot->echot("Project Name"); ?></label>
                                                <div class="col-sm-8 col-md-8">
                                                    <input type="text" class="form-control" id="editRequestProjectName"
                                                        name="editRequestProjectName" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-12 request-datetimeevent-wrap">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4 col-md-4">
                                                    <input id="reportEditDateTimeFrom" type="text"
                                                        class="edit-input form-control" name="reportEditDateTimeFrom"
                                                        placeholder="Select a start time for the task" />
                                                </div>
                                                <div class="col-sm-4 col-md-4">
                                                    <input id="reportEditDateTimeTo" type="text"
                                                        class="edit-input form-control" name="reportEditDateTimeTo"
                                    ...
                                    <div class="col-sm-12 request-payestimatedprice-wrap">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8 col-md-8 request-paymentestimatedprice-div">
                                                <input name="request_pay_estimatedprice" class="form-control"
                                                    id="request_pay_estimatedprice" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="editRequestmaterialReport-div">
                                    ...
                                    <div class="col-sm-12" id="editRequestmaterialProviderWrap">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8 col-md-8">
                                                ...
                                                <label class="radio-inline mr-sm-2">
                                                    <input id="editRequest-materialprovidervendor"
                                                        class="edit-input editRequest-material-provider" type="radio"
                                                        name="editRequestMaterialprovider" value="2">Vendor
                                                </label>
                                                <label class="radio-inline mr-sm-2">
                                                    <input id="editRequest-materialproviderowner"
                                                        class="edit-input editRequest-material-provider" type="radio"
                                                        name="editRequestMaterialprovider" value="1" checked> Owner
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="editRequestmaterial_detail_wrap_outer">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    <button type="button" id="editRequestaddMoreMaterial"
                                                        class="btn btn-primary "><i class="fas fa-plus"></i>
                                                        Material
                                                    </button>
                                                </div>
                                                <div class="col-sm-6">
                                                    <button type="button" id="editRequestmaterialDetailsSave"
                                                        class="btn btn-info "><i class="far fa-arrow-from-left"></i>
                                                        Save
                                                    </button>
                                                </div>
                                            </div>
                            ...
                            <div id="editRequestadd_more_material_proto" style="display:none;">
                                <div class="form-group material-wrap-main">
                                    <div class="row form-group">
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="editRequest_material[]"
                                                placeholder="Material Detail" />
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-2">
                                            <button class="btn btn-danger remove-material-detail"><i
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs" role="tablest" style="margin-top: 10px;">
                    ...
                    <li role="presentation"><a class="remove-for-tenant" id="recipient_report_tag"
                            href="#recipient_report" aria-controls="recipient_report" role="tab"
                            data-toggle="tab"><?php echo $DB_snapshot->echot("Recipients / Vendors"); ?></a>
                    </li>
                    <li role="presentation"><a id="material_report_tag" style="display:none;" href="#material_report"
                            aria-controls="material_report" role="tab"
                            data-toggle="tab"><?php echo $DB_snapshot->echot("Material Details"); ?></a>
                    </li>
                    ...
                    ?>
                    <!--</a></li>-->
                    <li role="presentation"><a id="pictures_new_report_tag" href="#pictures_new_report"
                            aria-controls="pictures_new_report" role="tab"
                            data-toggle="tab"><?php echo $DB_snapshot->echot("Pictures"); ?></a></li>
                    <li role="presentation"><a id="additional_info_new_report_tag" href="#additional_info_new_report"
                ...
                <div class="tab-content">
                                                ...
                                                <div class="col-sm-8 col-md-8">
                                                    <label class="radio-inline mr-sm-2">
                                                        <input id="report-tasktypeFixed"
                                                            class="edit-input request-newreportTasktype" type="radio"
                                                            name="newreportTasktype" value="1"> Fixed Event
                                                        <input type="checkbox" id="is_regular" name="is_regular" checked
                                                            style="display:none;">
                                                    </label>
                                                    <label class="radio-inline mr-sm-2">
                                                        <input id="report-tasktypeRequest"
                                                            class="edit-input request-newreportTasktype" type="radio"
                                                            name="newreportTasktype" value="0" checked> Request
                                                    </label>
                                                    <label class="radio-inline mr-sm-2">
                                                        <input id="report-tasktypeProject"
                                                            class="edit-input request-newreportTasktype" type="radio"
                                                            name="newreportTasktype" value="2"> Project
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="task-request-type-wrapper">
                                        ...
                                        <div class="row" id="projectTaskTypeOnlyShow" style="display: none;">
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    <label class="edit-label col-sm-4 col-md-3"
                                                        for="request-type"><?php echo $DB_snapshot->echot("Project Name"); ?></label>
                                                    <div class="col-sm-8 col-md-8">
                                                        <input type="text" name="project_name_newrequest"
                                                            id="project_name_newrequest" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8 col-md-8">
                                                        <select class="edit-select form-control request-type"
                                                            id="report-request-type" name="reportRequestType"
                                                            title="Type">
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-8 col-sm-offset-4">
                                                        <button data-target-tenant="pictures_new_report_tag"
                                                            data-target="recipient_report_tag" href="#recipient_report"
                    ...
                    <div role="tabpanel" class="tab-pane remove-for-tenant" id="recipient_report">
                        ...
                        <div class="recipientReport-div card card-default">
                            <div class="card-header">Add Vendors to this Task</div>
                            <div class="card-body bg-light">
                                ...
                                <form id="editRecipientReport">
                                    <div class="row form-group">
                                        <div class="col-sm-12" id="recipient-report-vendor-speciality-level-wrap">
                                            <div class="form-group row">
                                                <label
                                                    class="edit-label col-sm-4"><?php echo $DB_snapshot->echot("Speciality Level"); ?></label>
                                                <div class="col-sm-7">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-sm-12" id="recipient-report-vendor-speciality-wrap">
                                            <div class="form-group row">
                                                <label
                                                    class="edit-label col-sm-4"><?php echo $DB_snapshot->echot("Speciality"); ?></label>
                                                <div class="col-sm-7">
                                                    <?php $specialityTypes = $DB_request->get_request_types_all(); ?>
                                                    <select class="form-control" id="recipient-report-vendor-speciality"
                                    ...
                                    <div class="row form-group">
                                        <div class="col-sm-12" id="recipient-report-vendor-type-wrap">
                                            <div class="form-group row">
                                                <label
                                                    class="edit-label col-sm-4"><?php echo $DB_snapshot->echot("Type of Vendor"); ?></label>
                                                <div class="col-sm-7">
                                                    <?php $vendorTypes = $DB_vendor->getVendorTypes(); ?>
                                                    <select class="form-control" id="recipient-report-vendor-type"
                                    ...
                                    <div class="row form-group">
                                        <div class="col-sm-12" id="recipient-report-vendor-license-wrap">
                                            <div class="form-group row">
                                                <label
                                                    class="edit-label col-sm-4"><?php echo $DB_snapshot->echot("Licenses"); ?></label>
                                                <div class="col-sm-7">
                                                    <?php $licenseTypes = $DB_vendor->getLicenseTypes(); ?>
                                                    <select class="form-control" id="recipient-report-license-type"
                                    ...
                                    <div class="row form-group">
                                        <div class="col-sm-12" id="recipient-report-vendor-wrap" style="display:none;">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <select class="form-control" id="recipient-report-vendor"
                                    ...
                                    <div class="row form-group">
                                        <div class="col-sm-12" id="recipient-report-estimatedprice-wrap"
                                            style="display:none;">
                                            <div class="form-group row">
                                                <label
                                                    class="edit-label col-sm-4"><?php echo $DB_snapshot->echot("Estimated Price (CAD)"); ?></label>
                                                <div class="col-sm-7">
                                                    <input type="text" name="recipient-vendor-estimatedprice"
                                                        id="recipient-vendor-estimatedprice" class="form-control"
                                                        value="0" />
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="handymanReport-div card card-default">
                                        ...
                                        <div class="col-sm-12" id="handyman-report-wrap">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    ...
                                                    <select class="form-control" id="handyman-report-select"
                        ...
                        <div class="materialReport-div card card-default">
                            ...
                            <div class="card-body bg-light">
                                                ...
                                                <div class="col-sm-8 col-md-8">
                                                    ...
                                                    <label class="radio-inline mr-sm-2">
                                                        <input id="report-materialprovidervendor"
                                                            class="edit-input request-material-provider" type="radio"
                                                            name="reportMaterialprovider" value="2">Vendor
                                                    </label>
                                                    <label class="radio-inline mr-sm-2">
                                                        <input id="report-materialproviderowner"
                                                            class="edit-input request-material-provider" type="radio"
                                                            name="reportMaterialprovider" value="1" checked> Owner
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-8 col-md-8" id="reportMaterialWrap">
                                                        <button type="button" id="addMoreMaterial"
                                                            class="btn btn-primary "><i class="fas fa-plus"></i>
                                                            Material
                                                        </button>
                                                    </div>
                                ...
                                <div id="add_more_material_proto" style="display:none;">
                                    <div class="form-group material-wrap-main">
                                        <div class="row form-group">
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="request_material[]"
                                                    placeholder="Material Detail" />
                                            </div>
                                            <div class="col-md-3">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    <div class="col-sm-8 col-sm-offset-4">
                                        <button data-target="pictures_new_report_tag" type="button"
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control"
                                                            name="request_material[]" placeholder="Material Detail" />
                                                    </div>
                                                    <div class="col-md-3">
                                                        <select class="form-control"
                                                            name="request_material_purchase_shop[]">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group row">
                                            <div class="col-sm-4 col-md-offset-8" id="reportMaterialWrap">
                                                <button type="button" id="materialDetailsContinue"
                                                    class="btn btn-info "><i class="far fa-arrow-from-left"></i>
                                                    Continue
                                                </button>
                                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="invoices_report">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    <div class="col-sm-8 col-sm-offset-4">
                                        <button data-target="additional_info_new_report_tag" type="button"
                                            class="btn btn-warning reportNewTaskNextBtn"><?php echo $DB_snapshot->echot("Next"); ?>
                                            <i class="fas fa-arrow-right"></i></button>
                                        <button class="btn btn-secondary"
                                            data-dismiss="modal"><?php echo $DB_snapshot->echot("Cancel"); ?></button>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-8 col-md-8">
                                        <input class="form-control" name="contact_number" id="contact_number"
                                            pattern="[\+]\d{11}" placeholder="999-999-9999" maxlength="15">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-sm-8 col-md-8">
                                            <label class="radio-inline mr-sm-2">
                                                <input id="report-settaskdatetime"
                                                    class="edit-input request-settask-datetime" type="radio"
                                                    name="isRequestSetTaskDateTime" value="1">Yes
                                            </label>
                                            <label class="radio-inline mr-sm-2">
                                                <input id="report-donotsettaskdatetime"
                                                    class="edit-input request-settask-datetime" type="radio"
                                                    name="isRequestSetTaskDateTime" value="0" checked>No
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <input id="requestSetTaskDateTimePickerFrom" type="text"
                                                class="edit-input form-control" name="requestSetTaskDateTimeFrom"
                                                placeholder="Select a start time for the task" />
                                        </div>
                                        <div class="col-sm-4 col-md-4">
                                            <input id="requestSetTaskDateTimePickerTo" type="text"
                                                class="edit-input form-control" name="requestSetTaskDateTimeTo"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8 col-md-8" id="reportPicturesWrap">
                                                <label
                                                    ...
                                                    <input class="request-pic-upload" id="reportButton" type="file"
                                                ...
                                                <div id="reportNew_uploadImages"
                                                    ...
                                                    <button type="button" id="reportNew_uploadImages_btn"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-8 col-sm-offset-4">
                                        <button data-target="additional_info_new_report_tag"
                                            data-target-tenant="additional_info_new_report_tag" type="button"
                                            class="btn btn-warning reportNewTaskNextBtn"><?php echo $DB_snapshot->echot("Next"); ?>
                                            <i class="fas fa-arrow-right"></i></button>
                                        <button class="btn btn-secondary"
                                            data-dismiss="modal"><?php echo $DB_snapshot->echot("Cancel"); ?></button>
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs" role="tablest" style="margin-top: 10px;">
                    ...
                    <li role="presentation" class="remove-for-tenant"><a id="bullentin_read_status_tag"
                            ...
                            data-toggle="tab"><?php echo $DB_snapshot->echot("Read Tenants"); ?></a>
                    </li>
                </ul>
...
loadjs.ready(['datatable'], function() {
    ...
    $(function() {
        ...
        $(".newRequest-contract").on("click", function() {
            ...
            location.href = "requestadd?action=make&type=r&pid=" + project_id + "&cid=" +
                contract_id;
        });
        ...
        initCurrentRequestTable = function() {
            currentRequestTable = $('#currentRequestsTable').DataTable({
                ...
                buttons: [
                    ...
                    {
                        extend: 'pdfHtml5',
                        title: '<?= $CompanyName ?>' + ' - Current Requests',
                        exportOptions: {
            ...
            $('#currentRequestsTable tbody').on('click', '.rdetails_view', function(e) {
                ...
                if (request_id_selected) {
                    ...
                    if (user_level == 5) {
                        rview_url = "requestadd?action=rview&rid=" +
                            request_id_selected + "&unit_id= " + user_unit_id;
                    }
        ...
        initallRequestTable = function() {
            allRequestsTable = $('#allRequestsTable').DataTable({
                ...
                buttons: [
                    ...
                    {
                        extend: 'pdfHtml5',
                        title: '<?= $CompanyName ?>' + ' - All Requests',
                        exportOptions: {
                            columns: [0, 7, 1, 2, 3, 4, 5]
                        }
                    },
        ...
        initPastRequestTable = function() {
            ...
            pastRequestTable = $('#pastRequestsTable').DataTable({
                ...
                buttons: [
                    ...
                    {
                        extend: 'pdfHtml5',
                        title: '<?= $CompanyName ?>' + ' - Past Requests'
                    },
                    {
                        extend: 'excelHtml5',
                        title: '<?= $CompanyName ?>' + ' - Past Requests'
        ...
        <?php } else { ?>
        var projectRequestsDisplayTable = [];
        <?php } ?>
                ...
                success: function(response) {
                    if (response) {
                        ...
                        location.href = location.protocol + '//' + location.host +
                            location.pathname + "?type=p";
                    } else {
                        alert(
                            "There was an error in deleting the project. Try again!"
                        );
                    }
                }
            });
        ...
        $('#contractsDisplayTable tbody').on('click', '.contract-toggle-requests', function() {
            ...
            $(".data_projectcontracts_display").toggle("fade", {},
                700); // Toggle the contracts table
            $(".data_projectrequests_display").toggle("fade", {},
                700); // Show the project requests table
        });
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response) {
                        ...
                        alert(
                            "There was an error in deleting the contract. Try again!"
                        );
                    }
                }
            });
        ...
        $('#data_projectrequests_table tbody').on('click', 'tr', function() {
            ...
            if (request_id_selected) {
                window.location.href = "requestadd?action=rview&rid=" +
                    request_id_selected;
            }
        });
        ...
        $("body").on("click", ".toggle-contractdisplay", function() {
             ...
             * */
            contractsDisplayTable.ajax.url(
                "custom/request/request_info_controller.php?project_id=" + projectId +
                "&action=getContractsDisplay").load();
                ...
                if (typeValue == "c") {
                    ...
                    if (location.search.indexOf('cid=') >= 0) {
                        setTimeout(function() {
                            ...
                            projectIdParam = (location.search.split('pid=')[1] || '')
                                .split('&')[0];
                            $("#showContracts_project_" + projectIdParam).trigger(
                                "click",
                                function() {
                                    alert();
                                });
                            ...
                            setTimeout(function() {
                                contractIdParam = (location.search.split(
                                    'cid=')[1] || '').split('&')[0];
                                $("body").find("#contract_rowdisplay_" +
                                    contractIdParam).find(
                                    ".contract-toggle-requests").trigger(
                                    "click");
                            }, 2000);
                        }, 2000);
                    }
        ...
        var fixedEventsTable = $('#fixed_events_table').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'print',
                    title: '<?= $CompanyName ?>' + ' - Fixed Events',
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5]
                    }
                },
            ...
            success: function(result) {
                if (result && result != null) {
                    ...
                    for (var invoiceIndex in resultJson) {
                        ...
                        filePath = "files/requests/" + fileName;
    ...
    function set_recipients_view(data) {
        ...
        for (var x in employees) {
            ...
            $('#recipient-employee').append(
                ...
                employees[x].employee_id + '" ' + checked + '>' + employees[x].full_name +
                '</label></td></tr>');
        }
        ...
        if (data.tenants) {
            ...
            for (var y in tenants) {
                ...
                $('#recipient-tenant').append(
                    ...
                    tenants[y].tenant_id + '" ' + checked + '>' + tenants[y].full_name +
                    '</label></td></tr>')
            }
        }
    ...
    $("#recipient-vendor-estimatedprice").on("blur", function() {
        ...
        if (isNaN(price_value)) {
            strippedValue = price_value.replace(/\D/g,
    ...
    function submit_report() {
        ...
        vendor_estimated_price = $("#recipient-vendor-estimatedprice")
    ...
    function update_current_issue_page(data, page_number) {
        ...
        for (i in data_arr) {
            ...
            // alert(filter_selected_id);
            switch (filter_selected_id) {
                case "internal":
                    data_arr[i].style_class = "bg-success";
                    break;
                case "tenant":
                    data_arr[i].style_class = "bg-warning";
                    break;
                case "unread":
                    data_arr[i].style_class = "bg-danger";
                    break;
                default:
            ...
            tr_content = '<tr class="' + data_arr[i].style_class + ' issue-line ' + txt_class + ' " id="' + id +
                ...
                // '              <td data-search= "' + data_arr[i].request_id +
                // '" class="col-md-1 text-center">' + data_arr[i].request_id + '</td>\n' +
                '              <td data-rid= "' + data_arr[i].request_id + '" class="col-md-1 text-center">' +
                data_arr[i].created_time + '</td>\n' +
    ...
    function update_past_issue_page(data, page_number) {
        ...
        for (i in data_arr) {
            ...
            $('#past_issues_tbody').append('<tr class="' + data_arr[i].style_class + ' issue-line" id="' + id +
                ...
                '              <td class="col-md-1 text-center non-overflow"  data-toggle="tooltip" data-container="body" title="' +
                persson_info + '">' + data_arr[i].creator_full_name + '</td>\n' +
                '              <td class="col-md-1 text-center"> <span data-rid="' + data_arr[i]
                .request_id +
                '" class="btn btn-info rdetails_view"> <i class="fas fa-search"></i> </span> </td>\n' +
                '            </tr>');
        }
    ...
    function set_filter_units_allissues(data) {
        ...
        for (i in data_conent) {
            $('#filter_units_allissues').append('<option id="' + data_conent[i].apartment_id + '">' +
                data_conent[i].unit_number + '</option>');
        }
    }
    ...
    $(document).ready(function() {
        ...
        $('.filter_element').click(function(event) {
            if ($(this).attr("data-type") == "project" || $(this).attr("data-type") ==
                "fixed") {
                return;
            }
...
#body-loader {
    position: fixed;
    /*    background: url('custom/body-loader.gif') no-repeat center center;*/
    top: 0;
    left: 0;
    width: 100%;
    height: 100%;
