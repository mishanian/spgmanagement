        ...
        <div class="card-body bg-light">
            ...
            <ul class="nav nav-tabs">
                ...
                <?php if ($user_level == 1 || $user_level == 24) { ?>
                    <li class="nav-item">
                        <a id="addNewProjectTab" class="nav-link remove-for-tenant" data-bs-toggle="tab" href="#project_add"><i class="fas fa-plus"></i>New Project</a>
                    </li>
                <?php } ?>

                <li class="nav-item">
                    <a class="nav-link active" id="add_request_tag" data-bs-toggle="tab" href="#request_add"><i class="fas fa-plus"></i>
                ...
                <?php if (isset($_GET["action"]) && $_GET["action"] == "rview") { ?>
                    <li class="nav-item">
                        <a class="nav-link" id="viewrequest_tag" data-bs-toggle="tab" href="#request_view"> <i class="far fa-eye"></i> View Request
            ...
            <div class="tab-content">
                        ...
                        <div class="card bg-primary">
                            ...
                            <div class="card-body bg-light">
                                ...
                                <ul class="nav nav-tabs" role="tablist" style="margin-top: 10px;">
                                    <li role="presentation" class="nav-item active"><a class="nav-link active" id="report_details_tag" href="#report_details" aria-controls="report_details" role="tab" data-bs-toggle="tab"><?php echo $DB_snapshot->echot("Task Details"); ?></a>
                                    </li>
                                    <li class="nav-item" role="presentation"><a class="nav-link" id="pictures_new_report_tag" class="removeForFixedEventType" href="#pictures_new_report" aria-controls="pictures_new_report" role="tab" data-bs-toggle="tab"><?php echo $DB_snapshot->echot("Pictures"); ?></a>
                                    </li>
                                    <li class="nav-item" role="presentation"><a class="nav-link" id="additional_info_new_report_tag" href="#additional_info_new_report" aria-controls="additional_info_new_report" role="tab" data-bs-toggle="tab"><?php echo $DB_snapshot->echot("Additional Details"); ?></a>
                                    </li>
                                    <li class="nav-item" role="presentation"><a class="nav-link" class="removeForFixedEventType remove-for-tenant" style="<?php echo (isset($_GET["type"]) && $_GET["type"] == "sp") ? "display:none" : "" ?>" id="recipient_report_tag" href="#recipient_report" aria-controls="recipient_report" role="tab" data-bs-toggle="tab"><?php echo $DB_snapshot->echot("Invoices / Material"); ?></a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content" style="margin-top: 10px;">
                                        ...
                                        <div class="reportAnIssue">
                                            <div class="form">
                                                <form id="reportIssue" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row remove-for-tenant form-group" style="<?php echo $displayTaskType; ?>">
                                                        <div class="col-sm-12" id="newTaskType">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8 col-md-8">
                                                                    ...
                                                                    <?php if ($user_level == 1 || $user_level == 24) { ?>
                                                                        <label class="radio-inline mr-sm-2">
                                                                            <input id="report-tasktypeProject" class="edit-input request-newreportTasktype" type="radio" name="newreportTasktype" value="2"> Project / Contract
                                                                        </label>
                                                                    <?php } ?>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row form-group projectTaskTypeOnlyShow">
                                                        <div class="col-sm-12 project-select-wrap" id="projectSelectWrap">
                                                            <div class="form-group row">
                                                                <label class="edit-label col-sm-4 col-md-3" for="projectSelectDetail"><?php echo $DB_snapshot->echot("Project"); ?></label>
                                                                <div id="projectSelectDetailDiv" class="col-sm-4 col-md-4 project-id-div">
                                                                    <select class="edit-input form-control projectSelectDetail selectChanger" id="projectSelectDetail" name="projectSelectDetail">
                                                                        ...
                                                                        ?>
                                                                                <option data-location="<?php echo $projectInfo["location_id"]; ?>" value="<?php echo $projectInfo["project_id"]; ?>">
                                                    ...
                                                    <div class="row form-group projectTaskTypeOnlyShowDynamic" style="display: none;" id="contractSelectWrap">
                                                        <div class="col-sm-12">
                                                            <div class="form-group row">
                                                                <label class="edit-label col-sm-4 col-md-3" for="contractSelectDetail"><?php echo $DB_snapshot->echot("Contract"); ?></label>
                                                                <div id="contractSelectDetailDiv" class="col-sm-4 col-md-4">
                                                                    <select class="edit-input form-control selectChanger" id="contractSelectDetail" name="contractSelectDetail">
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row form-group" style="display: none;" id="contractvendorDetailWrap">
                                                        <div class="col-sm-12">
                                                            <div class="form-group row">
                                                                <label class="edit-label col-sm-4 col-md-3" for="contractVendorDetail"><?php echo $DB_snapshot->echot("Contract Vendor"); ?></label>
                                                                <div id="contractVendorDetailDiv" class="col-sm-4 col-md-4">
                                                    ...
                                                    <?php if (isset($_GET["action"]) && ($_GET["action"] == "make") && isset($_GET["type"]) && ($_GET["type"] == "vr") && isset($_GET["vid"])) { ?>
                                                        <div class="row form-group" id="specialRequestVendorNameWrap">
                                                            <div class="col-sm-12">
                                                                <div class="form-group row">
                                                                    <label class="edit-label col-sm-4 col-md-3" for="specialRequestVendorNameInput"><?php echo $DB_snapshot->echot("Vendor Name"); ?></label>
                                                                    <div id="specialRequestVendorNameDiv" class="col-sm-4 col-md-4">
                                                    ...
                                                    <div class="row form-group roomsInfoForTenant" style="display:none;">
                                                        <div class="col-sm-12 request-roomsinfo-wrap" id="reportRoomInfoWrap">
                                                            <div class="form-group row">
                                                                <label class="edit-label col-sm-4 col-md-3" for="location"><?php echo $DB_snapshot->echot("Room"); ?></label>
                                                                <div id="reportRoomInfo" class="col-sm-8 col-md-8">
                                                                    <select class="edit-input form-control report-roominfoselect" id="reportRoomInfoSelect" name="reportRoomInfoSelect">
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group row">
                                                                <div class="col-sm-8 col-sm-offset-4">
                                                                    <button type="button" data-bs-target-tenant="pictures_new_report_tag" data-fixedevent-target="additional_info_new_report_tag" data-bs-target="pictures_new_report_tag" href="#recipient_report" aria-controls="recipient_report" role="tab" data-bs-toggle="tab" type="button" class="btn btn-warning reportNewTaskNextBtn" id="reportNewTaskDetailNext"><?php echo $DB_snapshot->echot("Next"); ?>
                                    ...
                                    <div role="tabpanel" class="tab-pane remove-for-tenant" id="recipient_report">
                                            ...
                                            <div class="card-body bg-light">
                                                <div class="row">
                                                    <div class="col-sm-12 form-group">
                                                        <div class="form-group row">
                                                            <label class="edit-label col-sm-4 col-md-3"><?php echo $DB_snapshot->echot("Invoice Number"); ?></label>
                                                            <div class="col-sm-5 col-md-5">
                                                                <input type="text" class="form-control col-md-6 form-group" id="invoice_id_request" name="invoice_id_request" placeholder="Enter the Invoice Number" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 form-group">
                                                        <div class="form-group row">
                                                            <label class="edit-label col-sm-4 col-md-3"><?php echo $DB_snapshot->echot("Invoice Amount"); ?></label>
                                                            <div class="col-sm-5 col-md-5">
                                                                <input type="text" class="form-control col-md-6 form-group" id="invoice_amount_request" name="invoice_amount_request" placeholder="Enter the Invoice Amount" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <form id="newRequest_invoicefilesForm" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <span id="newRequest_invoicefiles_list" class="card" style="display: none;">
                                                        <h4>Files to Upload:</h4>
                                                        <ol></ol>

                                                        <button type="button" style="display: none;" type="submit" class="btn btn-primary start">
                                                ...
                                                <div style="display:none" class="form-group row" id="newRequest_invoicefiles_alert">
                                                            ...
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <input type="text" class="form-control request_material_purchase_url_input" name="request_material_purchase_url[]" placeholder="Material Online URL" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="form-group row">
                                                                <div class="col-sm-8 col-md-8" id="reportMaterialWrap">
                                                                    <button type="button" type="button" id="addMoreMaterial" class="btn btn-primary "><i class="fas fa-plus"></i> Material
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div id="add_more_material_proto" style="display:none;">
                                                    <div class="form-group material-wrap-main">
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-md-2">
                                                                <button type="button" class="btn btn-danger remove-material-detail"><i class="fa fa-remove"></i></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-8 col-sm-offset-4">
                                                        <button type="button" data-bs-target="additional_info_new_report_tag" data-fixedevent-target="additional_info_new_report_tag" type="button" class="btn btn-warning reportNewTaskNextBtn"><?php echo $DB_snapshot->echot("Next"); ?>
                                                            <i class="fas fa-arrow-right"></i></button>
                                                        <!--                                                        <button type="button" class="btn btn-default" data-dismiss="modal">-->
                                                        <?php //echo $DB_snapshot->echot("Cancel");
                                                        ?>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="invoices_report">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-8 col-sm-offset-4">
                                                        <button data-bs-target="additional_info_new_report_tag" type="button" class="btn btn-warning reportNewTaskNextBtn"><?php echo $DB_snapshot->echot("Next"); ?>
                                                            <i class="fas fa-arrow-right"></i></button>
                                                        <!--                                                        <button type="button" class="btn btn-default" data-dismiss="modal">-->
                                                        <?php //echo $DB_snapshot->echot("Cancel");
                                                        ?>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="additional_info_new_report">
                                        ...
                                        <form id="report_modaladditional_info_form">
                                            ...
                                            <div class="row remove-for-tenant removeForFixedEventType" style="<?php echo (isset($_GET["type"]) && $_GET["type"] == "sp") ? "display:none" : "" ?>">
                                                <div class="col-sm-12 col-sm-12 form-group mt-20" id="setTaskDateTimeWrap">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8 col-md-8">
                                                            <label class="radio-inline mr-sm-2">
                                                                <input id="report-settaskdatetime" class="edit-input request-settask-datetime mb-2 mr-sm-2" type="radio" name="isRequestSetTaskDateTime" value="1">Yes
                                                            </label>
                                                            <label class="radio-inline mr-sm-2">
                                                                <input id="report-donotsettaskdatetime" class="edit-input request-settask-datetime mb-2 mr-sm-2" type="radio" name="isRequestSetTaskDateTime" value="0" checked>No
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row removeForFixedEventType">
                                                <div class="col-sm-12 form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8 col-md-8">
                                                            <textarea id="reportMessage" class="edit-input form-control" placeholder="Please describe the issue as detailed as you can." name="reportMessage" rows="4" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card card-default removeForRequestTaskType">
                                                ...
                                                <div class="card-body bg-light">
                                                    <div class="row form-group ">
                                                        ...
                                                        <div class="col-sm-8 col-md-8">
                                                            <label class="checkbox-inline"><input type="checkbox" class=" mb-2 mr-sm-2" name="notification[]" value="sms_notif">SMS</label>
                                                            <label class="checkbox-inline"><input type="checkbox" class=" mb-2 mr-sm-2" name="notification[]" value="email_notif">Email</label>
                                                            <label class="checkbox-inline"><input type="checkbox" class=" mb-2 mr-sm-2" name="notification[]" value="voice_notif">Voice</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="input-group">
                                                                ...
                                                                <input min="0" type="number" class="form-control" id="notification_when" name="notification_when">
                                            ...
                                            <div class="row removeForFixedEventType">
                                                <div class="col-sm-12 request-notify-me-wrap form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8 col-md-8">
                                                            <label class="checkbox-inline"><input type="hidden" name="notifyMeByEmail" value="0"><input class="edit-input notify-me-by-email mb-2 mr-sm-2" type="checkbox" name="notifyMeByEmail" id="reportNotifyMeEmail" value="1"><?php echo $DB_snapshot->echot("Email"); ?>
                                                            </label>
                                                            <label class="checkbox-inline"><input type="hidden" name="notifyMeBySms" value="0"><input class="edit-input notify-me-by-sms  mb-2 mr-sm-2" type="checkbox" name="notifyMeBySms" id="reportNotifyMeSms" value="1"><?php echo $DB_snapshot->echot("SMS"); ?>
                                                            </label>
                                                            <label class="checkbox-inline"><input type="hidden" name="notifyMeByVoice" value="0"><input class="edit-input notify-me-by-voice mb-2 mr-sm-2" type="checkbox" name="notifyMeByVoice" id="reportNotifyMeVoice" value="1"><?php echo $DB_snapshot->echot("Voice"); ?>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group row">
                                                        <div class="col-sm-8 col-sm-offset-4">
                                                            ...
                                                            <?php if ($user_level == 1 || $user_level == 24) { ?>
                                                                <button type="button" class="btn btn-primary" id="submitReportGeneratePDf">
                                        ...
                                        <div class="row form-group" id="new_request_loader" style="display: none;">
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-8 col-sm-offset-3" id="new_request_loader_content">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="pictures_new_report">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8 col-md-8" id="reportPicturesWrap">
                                                                ...
                                                                <div id="newRequest_picture_uploader" class="form-group row">
                                                                ...
                                                                <div class="card card-default uploadedPicturesListWrap" style="display:none;">
                                                                    <div class="card-header">Uploaded Pictures</div>
                                                                    <div id="newRequest_picture_uploaded_list" class="card-body bg-light" style="display:none;">
                                                                        <ol></ol>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    <div class="col-sm-8 col-sm-offset-4">
                                                        <button data-bs-target="additional_info_new_report_tag" data-bs-target-tenant="additional_info_new_report_tag" type="button" class="btn btn-warning reportNewTaskNextBtn"><?php echo $DB_snapshot->echot("Next"); ?>
                                                            <i class="fas fa-arrow-right"></i></button>
                                                        <!--                                                        <button type="button" class="btn btn-default" data-dismiss="modal">-->
                                                        <?php //echo $DB_snapshot->echot("Cancel");
                                                        ?>
                ...
                <div id="project_add" class="tab-pane container fade">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item active"><a class="nav-link active" style="background: antiquewhite;" data-bs-toggle="tab" href="#project_add_inner"><i class="fas fa-plus"></i>
                                <strong>Add New Project</strong> </a>
                        </li>

                        <li class="nav-item"><a class="nav-link" id="newContractAddTab" data-bs-toggle="tab" href="#contract_add_inner"><i class="fas fa-plus"></i> New Vendor
                                Contract</a>
                        </li>
                    </ul>
                                        ...
                                        <div class="form">
                                            <form id="reportProject" enctype="multipart/form-data">
                                                <div class="row form-group">
                                                    <div class="col-sm-12">
                                                        <div class="form-group row">
                                                            <label class="edit-label col-sm-4 col-md-3" for="project_name_newproject"><?php echo $DB_snapshot->echot("Project Name"); ?></label>
                                                            <div class="col-sm-4 col-md-4">
                                                                <input type="text" name="project_name_newproject" id="project_name_newproject" class="form-control" placeholder="Give your project a name!" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-sm-12 project-location-wrap" id="projectLocationWrap">
                                                        <div class="form-group row">
                                                            <label class="edit-label col-sm-4 col-md-3" for="projectLocation"><?php echo $DB_snapshot->echot("Project Location"); ?></label>
                                                            <div id="projectLocationDiv" class="col-sm-4 col-md-4 project-location-div">
                                                                <select class="edit-input form-control projectLocation selectChanger" id="projectLocation" name="projectLocation">
                                                                    <option value="default">Select a Location</option>
                                                                    <?php
                                                                    if ($locationInfos) {
                                                                        foreach ($locationInfos as $locationInfo) {
                                                                    ?>
                                                                            <option value="<?php echo $locationInfo["location_id"]; ?>">
                                                ...
                                                <div class="row form-group" id="project_address_newproject_wrap" style="display: none;">
                                                    <div class="col-sm-12">
                                                        <div class="form-group row">
                                                            <label class="edit-label col-sm-4 col-md-3" for="project_address_newproject"><?php echo $DB_snapshot->echot("Project Address"); ?></label>
                                                            <div class="col-sm-4 col-md-4">
                                                                <input type="text" name="project_address_newproject" id="project_address_newproject" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group row">
                                                            <div class="col-sm-8 col-sm-offset-4">
                                                                <button type="button" class="btn btn-primary btnClicker" id="createProjectNew"><?php echo $DB_snapshot->echot("Create Project"); ?></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row form-group mt-20">
                                                    <div class="col-sm-12">
                                                        <div class="alert alert-success" id="create_project_success" style="display: none;"></div>
                                                    </div>
                                                </div>
                                        ...
                                        <form id="reportContract" enctype="multipart/form-data">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-sm-12 contract_description_wrap">
                                                            <div class="form-group row">
                                                                <label class="col-sm-4 col-md-3" for="contract_description_detail"><?php echo $DB_snapshot->echot("Contract Description"); ?></label>
                                                                <div class="col-sm-4 col-md-4  contract-contract_description_detail-div">
                                                                    <input name="contract_description_detail" class="form-control" id="contract_description_detail">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-sm-12 project-id-wrap" id="projectIdWrap">
                                                            <div class="form-group row">
                                                                <label class="edit-label col-sm-4 col-md-3" for="projectIdDetail"><?php echo $DB_snapshot->echot("Project"); ?></label>
                                                                <div id="projectIdDetailDiv" class="col-sm-4 col-md-4 project-id-div">
                                                                    <select class="edit-input form-control projectIdDetail" id="projectIdDetail" name="projectIdDetail">
                                                                        <option value="default">Select a Project
                                                                        </option>
                                                                        <?php
                                                                        if ($projectInfos) {
                                                                        ...
                                                                        ?>
                                                                                <option value="<?php echo $projectInfo["project_id"]; ?>">
                                                                                    <?php echo $projectInfo["name"]; ?>
                                                                                </option>
                                                                        <?php
                                                                            }
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-sm-12 contract-type-wrap" id="contractIdWrap">
                                                            <div class="form-group row">
                                                                <label class="edit-label col-sm-4 col-md-3" for="projectIdDetail"><?php echo $DB_snapshot->echot("Type of Work"); ?></label>
                                                                <div id="contractIdDiv" class="col-sm-4 col-md-4 contract-id-div">
                                                                    <select class="edit-input form-control contractIdDiv" id="contractIdtype" name="contractIdtype">
                                                                        <option value="default">Select type</option>
                                                                        <?php
                                                                        if ($requestTypesInfos) {
                                                                            foreach ($requestTypesInfos as $requestTypesInfo) {
                                                                        ?>
                                                                                <option value="<?php echo $requestTypesInfo["id"]; ?>">
                                                            ...
                                                            <form id="editRecipientReport">
                                                                ...
                                                                <div class="row form-group">
                                                                    <div class="col-sm-12" id="recipient-report-vendor-speciality-level-wrap">
                                                                        <div class="form-group row">
                                                                            <label class="edit-label col-md-3 col-sm-4"><?php echo $DB_snapshot->echot("Speciality Level"); ?></label>
                                                                            <div class="col-sm-4 col-md-4">
                                                                ...
                                                                <div class="row form-group">
                                                                    <div class="col-sm-12" id="recipient-report-vendor-speciality-wrap">
                                                                        <div class="form-group row">
                                                                            <label class="edit-label col-md-3 col-sm-4"><?php echo $DB_snapshot->echot("Speciality"); ?></label>
                                                                            <div class="col-sm-4 col-md-4">
                                                                ...
                                                                <div class="row form-group">
                                                                    <div class="col-sm-12" id="recipient-report-vendor-type-wrap">
                                                                        <div class="form-group row">
                                                                            <label class="edit-label col-md-3 col-sm-4"><?php echo $DB_snapshot->echot("Type of Vendor"); ?></label>
                                                                            <div class="col-sm-4 col-md-4">
                                                                ...
                                                                <div class="row form-group">
                                                                    <div class="col-sm-12" id="recipient-report-vendor-license-wrap">
                                                                        <div class="form-group row">
                                                                            <label class="edit-label col-md-3 col-sm-4"><?php echo $DB_snapshot->echot("Licenses"); ?></label>
                                                                            <div class="col-sm-4 col-md-4">
                                                                ...
                                                                <div class="row form-group">
                                                                    <div class="col-sm-12" id="recipient-report-vendor-wrap" style="display:none;">
                                                                        <div class="form-group row">
                                                                            <label class="edit-label col-md-3 col-sm-4"><?php echo $DB_snapshot->echot("Vendors"); ?></label>
                                                                            <div class="col-sm-4 col-md-4">
                                                                ...
                                                                <div class="row form-group">
                                                                    <div class="col-sm-12" id="recipient-report-estimatedprice-wrap" style="display:none;">
                                                                        <div class="form-group row">
                                                                            <label class="edit-label col-md-3 col-sm-4"><?php echo $DB_snapshot->echot("Estimated Price (CAD)"); ?></label>
                                                                            <div class="col-sm-4 col-md-4">
                                                                ...
                                                                <div class="row form-group">
                                                                    <div class="col-sm-12" id="recipient-report-contractprice-wrap" style="display:none;">
                                                                        <div class="form-group row">
                                                                            <label class="edit-label col-md-3 col-sm-4"><?php echo $DB_snapshot->echot("Contract Price (CAD)"); ?></label>
                                                                            <div class="col-sm-4 col-md-4">
                                                                                <input type="text" name="recipient-vendor-contractprice" id="recipient-vendor-contractprice" class="form-control" value="0" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group row">
                                                        <div class="col-sm-8 col-sm-offset-4">
                                                            <button type="button" class="btn btn-primary btnClicker" id="createContractNew"><?php echo $DB_snapshot->echot("Create a Contract"); ?></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group mt-20">
                                                <div class="col-sm-12">
                                                    <div class="alert alert-success" id="create_contract_success" style="display: none;"></div>
                                                </div>
                                            </div>
                        ...
                        <div id="iModal">
                            <div>
                                <div style="padding: 10px 16px">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist" style="margin-top: 10px;">
                                        <li role="presentation" class="nav-item active"><a class="nav-link" id="communication_tag" href="#communication" aria-controls="communication" role="tab" data-bs-toggle="tab"><?php echo $DB_snapshot->echot("Communications"); ?></a>
                                        </li>
                                        ...
                                        ?>
                                        <!--</a></li>-->
                                        <li class="nav-item" role="presentation"><a class="nav-link" id="recipient_tag" href="#recipient" aria-controls="recipient" role="tab" data-bs-toggle="tab"><?php echo $DB_snapshot->echot("Recipient"); ?></a>
                                        </li>
                                        <li class="nav-item" role="presentation"><a class="nav-link" id="edit_tag" href="#edit" aria-controls="edit" role="tab" data-bs-toggle="tab"><?php echo $DB_snapshot->echot("Info"); ?></a>
                                        </li>
                                        ...
                                        <!--</a>-->
                                        <!--                                        </li>-->
                                        <li class="nav-item" role="presentation"><a class="nav-link" class="remove-for-tenant" id="materials_tag" href="#materialedit_tab" aria-controls="materialedit_tab" role="tab" data-bs-toggle="tab"><?php echo $DB_snapshot->echot("Materials"); ?></a>
                                        </li>
                                        <li class="nav-item" role="presentation"><a class="nav-link" class="remove-for-tenant" id="invoices_report_tag" href="#invoices_report_tab" aria-controls="invoices_report_tab" role="tab" data-bs-toggle="tab"><?php echo $DB_snapshot->echot("Attached Invoices"); ?></a>
                                        </li>
                                        ...
                                        if ($user_level == 5) {
                                            ...
                                            ?>
                                                <li role="presentation" style="float: right;">
                                                    <button type="button" style="font-weight: 550;" class="btn btn-danger" id="mark_request_complete_tenant" data-rid="<?php echo (isset($request_id)) ? $request_id : 0; ?>">
                                        ...
                                        if (intval($is_admin) == 1 || intval($user_level) == 1) {
                                            ...
                                            ?>
                                                <li role="presentation" style="float: right;margin-right: 10px;">
                                                    <button type="button" style="font-weight: 550;" class="btn btn-danger" id="mark_request_workinprogress_manager" data-rid="<?php echo (isset($request_id)) ? $request_id : 0; ?>">
                                    ...
                                    <div class="tab-content">
                                                ...
                                                <form enctype="multipart/form-data" id="post_communication_form">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 form-group" id="opeartions_new_message">
                                                            <button type="button" class="btn btn-primary btn-post" id="post_communication"><?php echo $DB_snapshot->echot("Post"); ?></button>

                                                            <?php
                                                            if ($user_level != 5) {
                                                            ?>
                                                                <button type="button" class="btn btn-danger btn-post" id="post_communication_and_close"><?php echo $DB_snapshot->echot("Post & Close"); ?></button>
                                                            <?php } ?>

                                                            <label class="btn btn-primary btn-post">Add Image
                                                                <input class="request-pic-upload" type="file" id="request-pic-upload" name="upload_img[]" style="display: none" accept="image/*" multiple>
                                                            </label>
                                                ...
                                                <div class="form">
                                                    <form id="editRecipient">
                                                        <div class="row">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-7">
                                                                        ...
                                                                        <div class="dropup" id="recipient_dropdown_list">
                                                                            <button style="width:50%;" class="btn btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">
                                                                                List
                                                            ...
                                                            <div class="col-sm-12 vendor-recipient-wraps" style="display:none;">
                                                                <div class="form-group row">
                                                        ...
                                                        <?php if ($orderData["task_type"] == 2) { ?>
                                                            <div class="showOnlyForProject">
                                                                <div class="row remove-for-tenant">
                                                                    <div class="col-sm-12 ">
                                                                        <div class="form-group row">
                                                                            <label class="edit-label col-sm-4 col-md-3" for="location"><?php echo $DB_snapshot->echot("Project Name"); ?></label>
                                                                            <div class="col-sm-8 col-md-8">
                                                                ...
                                                                <div class="row remove-for-tenant">
                                                                    <div class="col-sm-12 request-location-wrap">
                                                                        <div class="form-group row">
                                                                            <label class="edit-label col-sm-4 col-md-3" for="location"><?php echo $DB_snapshot->echot("Contract Name"); ?></label>
                                                                            <div class="col-sm-8 col-md-8">
                                                                                <?php
                                                                ...
                                                                <div class="row remove-for-tenant">
                                                                    <div class="col-sm-12 request-location-wrap">
                                                                        <div class="form-group row">
                                                                            <label class="edit-label col-sm-4 col-md-3" for="location"><?php echo $DB_snapshot->echot("Contract Price"); ?></label>
                                                                            <div class="col-sm-8 col-md-8">
                                                                                <?php
                                                                ...
                                                                <div class="row remove-for-tenant">
                                                                    <div class="col-sm-12 request-location-wrap">
                                                                        <div class="form-group row">
                                                                            <label class="edit-label col-sm-4 col-md-3" for="location"><?php echo $DB_snapshot->echot("Balance Contract Price"); ?></label>
                                                                            <div class="col-sm-8 col-md-8">
                                                                                <?php
                                                                                echo "$ $billBalance";
                                                                                ?>
                                                            ...
                                                            <div class="col-sm-12 request-location-wrap">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-8 col-md-8">
                                                                        ...
                                                                        ?>
                                                                        <textarea style="<?php echo $commonAreaDisplay; ?>" class="form-control" id="editRequestLocationCommonArea" name="editRequestLocationCommonArea" rows="1" placeholder="Specific Common Area (e.g. Elevator No.2)"><?php echo (isset($orderData["common_area_detail"])) ? ltrim($orderData["common_area_detail"]) : ""; ?> </textarea>
                                                                        ...
                                                                        <select style="<?php echo $aptDisplayInit; ?>" class="form-control form-group" id="editRequestLocationApt" name="editRequestLocationApt">
                                                                            <?php
                                                                            if (isset($aptData)) {
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-8 col-md-8 request-message-div">
                                                                        <textarea id="editMessage" class="edit-input form-control request-message" name="message" rows="4" required><?php echo (isset($orderData["message"])) ? $orderData["message"] : ""; ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-sm-12 request-status-wrap">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-8 col-md-8 request-status-div">
                                                                        <select class="edit-select form-control request-status" id="request-status" name="request_status" title="Status" <?php
                                                        ...
                                                        <div class="col-sm-12 request-payestimatedprice-wrap">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4 col-md-4  request-paymentestimatedprice-div">
                                                                    <input min="0" type="number" name="request_pay_estimatedprice" class="form-control" id="request_pay_estimatedprice" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-12 request-payperhr-wrap">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4 col-md-4 request-paymentperhr-div">
                                                                    <input min="0" type="number" name="request_pay_perhr" class="form-control" id="request_pay_perhr" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-12 request-payhours-wrap">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4 col-md-4 request-paymenthours-div">
                                                                    <input min="0" type="number" class="form-control" id="request_payhours" name="request_payhours">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-12 request-payexpenses-wrap">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4 col-md-4 request-paymentexpenses-div">
                                                                    <input min="0" type="number" class="form-control" id="request_pay_expenses" name="request_pay_expenses">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col-sm-12 request-payfinalamt-wrap">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4 col-md-4 request_approve_finalamt-div">
                                                                        <input type="number" class="form-control" name="request_approve_finalamt" id="request_approve_finalamt" placeholder="Enter the final amount to Pay">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="editRequestmaterial_detail_wrap_outer">
                                                                ...
                                                                <div id="editRequestmaterial_existing_row_input" class="row form-group">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                <input type="text" class="form-control request_material_purchase_url_input" name="editRequest_material_purchase_url[]" placeholder="Material Online URL" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                        ...
                                                                        foreach ($materialDataArray as $material) { ?>
                                                                            ...
                                                                            <div class="form-group material-wrap-main">
                                                                                <div class="row form-group">
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        <input type="text" class="form-control request_material_purchase_url_input" name="editRequest_material_purchase_url[]" placeholder="Material Online URL" value="<?php echo $material["material_url"]; ?>" />
                                                                                    </div>
                                                                                    <div class="col-md-2">
                                                                                        <button type="button" class="btn btn-danger remove-material-detail">
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col-sm-12">
                                                                <div class="form-group row">
                                                                    <div class="col-sm-6">
                                                                        <button type="button" id="editRequestaddMoreMaterial" class="btn btn-primary "><i class="fas fa-plus"></i> Material
                                                                        </button>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="invoices_report_tab">
                                            ...
                                            ?>
                                                    <div class="card bg-primary mt-20 invoicefileAttachedHolder" id="onloadExistingInvoicescard">
                                                        ...
                                                        <div class="card-body bg-light">
                                                            <ol id="report_edit_attachedInvoices_ol">
                                                                ...
                                                                foreach ($invoicesDataArray as $index => $invoice) { ?>
                                                                    <li> <?php echo $invoice; ?> <a target="_blank" href="<?php echo "files/requests/$invoice"; ?>" class="btn-xs btn-primary">View</a>
                                                                        <a class="btn-xs deleteAttachedInvoiceFile" href="#" data-findex="<?php echo $index; ?>">
                                            ...
                                            <div id="editRequest_invoicefilesForm_filesattachedAgain" class="invoicefileAttachedHolder" style="display:none;">
                                            ...
                                            <div class="card card-default removeForFixedEventType">
                                                ...
                                                <div class="card-body bg-light">
                                                    <form id="editRequest_invoicefilesForm" method="POST" enctype="multipart/form-data">
                                                        <div class="form-group row fileupload-buttonbar">
                                                            <div class="col-lg-7">
                                                                <span class="btn btn-info fileinput-button">
                                                                    <i class="glyphicon glyphicon-plus"></i>
                                                                    <span>Add files...</span>
                                                                    <input type="file" name="editRequest_invoicefiles[]" id="editRequest_invoicefiles" multiple>
                                                                </span>
                                                            </div>
                                                        </div>

                                                        <span id="editRequest_invoicefiles_list" class="card" style="display: none;">
                                                            <h4>Files to Upload:</h4>
                                                            <ol></ol>
                                                    ...
                                                    <div style="display:none" class="form-group row" id="editRequest_invoicefiles_alert">
                                                ...
                                                <div class="card-body bg-light">
                                                    <div class="row">
                                                        <div class="col-sm-12 form-group">
                                                            <div class="form-group row">
                                                                <label class="edit-label col-sm-4 col-md-3"><?php echo $DB_snapshot->echot("Invoice Number"); ?></label>
                                                                <div class="col-sm-5 col-md-5">
                                                                    <input type="text" class="form-control col-md-6 form-group" id="invoice_id_request_edit" name="invoice_id_request_edit" placeholder="Enter the Invoice Number" value="<?php echo (isset($invoiceId) && !empty($invoiceId)) ? $invoiceId : ""; ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 form-group">
                                                            <div class="form-group row">
                                                                <label class="edit-label col-sm-4 col-md-3"><?php echo $DB_snapshot->echot("Invoice Amount"); ?></label>
                                                                <div class="col-sm-5 col-md-5">
                                                                    <input type="text" class="form-control col-md-6 form-group" id="invoice_amount_request_edit" name="invoice_amount_request_edit" placeholder="Enter the Invoice Amount" value="<?php echo (isset($invoiceAmount)) ? $invoiceAmount : 0; ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-12 form-group">
                                                            <div class="form-group row">
                                                                <div class="col-sm-7 col-md-7">
                                                                    <button type="button" id="saveInvoiceDetailsEditRequest" class="btn btn-primary">Save
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 form-group">
                                                            <div class="form-group row">
                                                                <div class="col-sm-7 col-md-7">
                                                                    <div class="alert alert-success" style="display:none;" id="invoiceUpdateAlertEditRequest"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="generatePdf_slide1">
                ...
                <div class="modal-footer">
                    <button id="generate_pdf_report_submit" type="button" class="btn btn-primary generatePdf_slide1" style="float: left;">
                        Download PDF
                    </button>

                    <button type="button" id="generateRequestPdfSubmitEmail" style="float: left;" class="btn btn-danger" title="Email the PDF">Email PDF
                    </button>
            ...
            <div class="generatePdf_slide2" style="display:none;">
                ...
                <div class="modal-body">
                    <div id="generateRequestPdfSubmitEmailHtml">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <select id="generateRequestPdfSubmitNameValue1">
                                            ...
                                            foreach ($allvendorNames as $vendorListItem) { ?>
                                                <option data-email="<?php echo $vendorListItem["email"]; ?>" value="<?php echo $vendorListItem["id"]; ?>">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <textarea id="generateRequestPdfSubmitCommentsValue" class="form-control" placeholder="Comments"></textarea>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" style="float: left;" class="btn btn-danger showgeneratePdf_slide1"><i class="fas fa-arrow-left"></i> Show
                        Messages
                    </button>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data) {
                            ...
                            setTimeout(function() {
                                window.location.href = 'requests?unit_id=' +
                                    user_unit_id + "&type=f";
                            }, 700);
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    ...
                    if (buttonId == "submitReportGeneratePDf") {
                        ...
                        window.location.href = 'requests?unit_id=' + user_unit_id + "&type=" +
                            url_append;
                    }
                },
                success: function(response) {},
