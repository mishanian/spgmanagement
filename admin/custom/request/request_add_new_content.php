    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <ul class="nav nav-tabs">
                ...
                <?php if (isset($_GET["action"]) && $_GET["action"] == "rview") { ?> <li><a id="viewrequest_tag"
                        data-toggle="tab" href="#request_view">View Request <span id="request-num-val"></span></a></li>
                <?php } ?>
            </ul>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <ul class="nav nav-tabs" role="tablist" style="margin-top: 10px;">
                                    <li role="presentation" class="active"><a id="report_details_tag"
                                            href="#report_details" aria-controls="report_details" role="tab"
                                    ...
                                    <li role="presentation"><a id="pictures_new_report_tag"
                                            class="removeForFixedEventType" href="#pictures_new_report"
                                            aria-controls="pictures_new_report" role="tab"
                                            data-toggle="tab"><?php echo $DB_snapshot->echot("Pictures"); ?></a></li>
                                    <li role="presentation"><a id="additional_info_new_report_tag"
                                            href="#additional_info_new_report"
                                        ...
                                        <div class="reportAnIssue">
                                            <div class="form">
                                                <form id="reportIssue" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row form-group" id="projectTaskTypeOnlyShow"
                                                        style="display: none;">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <label class="edit-label col-sm-4 col-md-3"
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-sm-8 col-sm-offset-4">
                                                                    <button data-target-tenant="pictures_new_report_tag"
                                                                        data-target="recipient_report_tag"
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <form id="newRequest_invoicefilesForm" method="POST"
                                                    ...
                                                    <span id="newRequest_invoicefiles_list" class="panel"
                                                        style="display: none;">
                                                        ...
                                                        <div class="col-sm-8 col-md-8">
                                                            <label class="radio-inline">
                                                                <input id="report-settaskdatetime"
                                                                    class="edit-input request-settask-datetime"
                                                    ...
                                                    <div class="row form-group ">
                                                        ...
                                                        <div class="col-sm-8 col-md-8">
                                                            <label class="checkbox-inline"><input type="checkbox"
                                                                    name="notification[]" value="sms_notif">SMS</label>
                                                            <label class="checkbox-inline"><input type="checkbox"
                                                                    name="notification[]"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-8 col-sm-offset-4">
                                                            <button id="create_fixed_event" type="button"
                                                                class="btn btn-primary btn-long">Create Fixed
                                                                Event</button>
                                                            <button class="btn btn-default"
                                                                data-dismiss="modal"><?php echo $DB_snapshot->echot("Cancel"); ?></button>
                                                        </div>
                                                            ...
                                                            <div class="col-sm-8 col-md-8" id="reportPicturesWrap">
                                                                <label
                                                                    class="btn btn-primary btn-file"><?php echo $DB_snapshot->echot("Select Images"); ?><input
                                                                        class="request-pic-upload" id="reportButton"
                    ...
                    <div id="iModal">
                        <div>
                            <div style="padding: 10px 16px">
                                ...
                                <ul class="nav nav-tabs" role="tablist" style="margin-top: 10px;">
                                    <li role="presentation" class="active"><a id="communication_tag"
                                            href="#communication" aria-controls="communication" role="tab"
                                    ...
                                    <li role="presentation"><a id="recipient_tag" href="#recipient"
                                            aria-controls="recipient" role="tab"
                                            data-toggle="tab"><?php echo $DB_snapshot->echot("Recipient"); ?></a></li>
                                    <li role="presentation"><a id="edit_tag" href="#edit" aria-controls="edit"
                                            role="tab" data-toggle="tab"><?php echo $DB_snapshot->echot("Order"); ?></a>
                                    </li>
                                    <li role="presentation"><a id="payment_tag" href="#payment_tab"
                                            aria-controls="payment_tab" role="tab"
                                            data-toggle="tab"><?php echo $DB_snapshot->echot("Payment"); ?></a></li>
                                    <li role="presentation"><a class="remove-for-tenant" id="materials_tag"
                                            href="#materialedit_tab" aria-controls="materialedit_tab" role="tab"
                                            data-toggle="tab"><?php echo $DB_snapshot->echot("Materials"); ?></a></li>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8 col-md-8">
                                                                    ...
                                                                    <textarea style="<?php echo $commonAreaDisplay; ?>"
                                                                        ...
                                                                        placeholder="Specific Common Area (e.g. Elevator No.2)">
                                                                            <?php
                                                    ...
                                                    <div class="col-sm-12 request-payestimatedprice-wrap">
                                                        <div class="form-group">
                                                            ...
                                                            <div
                                                                ...
                                                                <input name="request_pay_estimatedprice"
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-sm-6">
                                                                    <button type="button"
                                                                        ...
                                                                        class="btn btn-primary "> <i
                                                                            class="fas fa-plus"></i> Material</button>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <button type="button"
                                                                        id="editRequestmaterialDetailsSave"
                                                                        class="btn btn-info "> <i
                                                                            class="far fa-arrow-from-left"></i> Save
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </div>
