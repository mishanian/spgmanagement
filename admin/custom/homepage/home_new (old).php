...
<head>
    ...
    <title>Welcome to SPG Management System</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  WHERE RI.status_id=1 AND AI.company_id = 9
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../home" class="brand-link">
                ...
                <img src="../../../images/logo_alone.jpg" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">SPG Management</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="../../files/employees/pictures/<?= (!empty($_SESSION['UserPicture']) ? $_SESSION['UserPicture'] : 'profile_icon.png') ?>"
                            class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block"><?= $_SESSION['UserFullName'] ?></a>
                    </div>
                </div>
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        ...
                                        <button type="button" class="btn btn-tool" data-toggle="tooltip"
                                            title="Contacts" data-widget="chat-pane-toggle2">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-infos clearfix">
                                                <span
                                                    class="direct-chat-name float-left"><?= $request['building_name'] ?>
