  ...
  <div class="container">
    ...
    <form class="well form-horizontal" action="action.php" method="post"  id="investigation_form">
      <fieldset>
        ...
        <legend><img src="logo.PNG" alt="logo" style="width:100px;height:80px;">Credit Investigation<a class="language" href="form_fr.php">Français</a><a class="language" href="form_cn.php">中文|</a></legend>
        ...
        <div class="form-group">
          ...
          <label class="col-md-12 control-label-info">Please Complete all * fields or application will be returned to you unprocessed.</label>
        </div>
        ...
        <div class="form-group">
          ...
          <label class="col-md-2 control-label">Passport ID</label>
          <div class="col-md-2 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        ...
        <div class="form-group">
          ...
          <label class="col-md-2 control-label">SIN No.</label>
          <div class="col-md-2 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label">How long have lived there?</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
          ...
          <label class="col-md-4 control-label">Your Name on the Lease</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label">Name of the Landlord</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
          ...
          <label class="col-md-4 control-label">*Tel of Landlord</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label">*End of Current Lease Date</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
          ...
          <label class="col-md-4 control-label">*Current Rent</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-2 control-label">Name of Employer</label>
          <div class="col-md-5 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label">Occupational Title</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
          ...
          <label class="col-md-4 control-label">Monthly Salary</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label">How long have worked there?</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
          ...
          <label class="col-md-4 control-label">Other resource of Income</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        ...
        <div class="form-group">          
          <label class="col-md-9 control-label">Do you have the most recent pay-stub? If yes, please send to <a href="mailto:info@spg-canada.com" target="_top">info@spg-canada.com</a>.</label>
          <div class="col-md-2 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-11 control-label"><I class="span_banking">You can also provide us an void check by email, so you don't need to fill the Banking information below.</I></label>
        </div>


        <div class="form-group">
          <label class="col-md-4 control-label">Name of Bank</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
          ...
          <label class="col-md-4 control-label">Bank Branch Address</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
        ...
        <div class="form-group">
          ...
          <label class="col-md-4 control-label">Transit Number</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label">Institutional Number</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label">Credit Card Company</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
        ...
        <div class="form-group">          
          ...
          <label class="col-md-4 control-label">Type of Insurance</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-4 control-label">Insurance Company Name</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-credit-card"></i></span>
          ...
          <label class="col-md-4 control-label">Policy No.</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-credit-card"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-11 control-label"><I class="span_banking">To make your moving more smooth, provide us with your hydroquebec account number for us to contact HydroQuebec on your behalf.</I></label>
        </div>

        <div class="form-group">
          <label class="col-md-4 control-label">HydroQuebec Account #</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-credit-card"></i></span>
          ...
          <label class="col-md-4 control-label">Moving Date</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-7 control-label">Account is active on the current above mentioned address.</label>
          <div class="col-md-2 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-6 control-label">Have you ever been convicted of a crime?</label>
          <div class="col-md-2 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
          ...
          <label class="col-md-6 control-label">Have you ever declared bankruptcy?</label>
          <div class="col-md-2 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-7 control-label">Have you ever been opening a file in Regie du Logement of Quebec?</label>
          <div class="col-md-2 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-7 control-label">Have you ever been declined by a Credit Card Company, if yes, which credit card.</label>
          <div class="col-md-2 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
        ...
        <div class="form-group">
          <label class="col-md-7 control-label">If yes, name of the Credit Card Company.</label>
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-credit-card"></i></span>
        ...
        <div class="form-group">
          ...
          <div class="col-md-7">
            <button type="submit" class="btn btn-warning btn-size" name="form_submit">Submit<span class="glyphicon glyphicon-send"></span></button>
          </div>
        </div>
