<?php
/**
 * This sendSMSEmail file to control the notification for Services module
*/
...
function SendEmail($FromEmail="info@mgmgmt.ca",$FromName="Info - spgmanagement.com",$ToEmail,$ToName,$Subject,$Message,$CCEmail=null,$CCName=null){
