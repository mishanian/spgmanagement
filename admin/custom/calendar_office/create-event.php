                    ...
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Create a
                                <?php echo ucfirst($event_type) . " " . ucfirst($event_category); ?> Event</li>
                        </ol>
                        <div class="page-title-left">
                            <h2>Create a <?php echo ucfirst($event_type) . " " . ucfirst($event_category); ?> Event</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div id="content-area" class="contact-area">
                        <div class="white-block">
                            <div class="row">
                                ...
                                <form id="create-regular-event-form" action="controller_event.php" method="post">
