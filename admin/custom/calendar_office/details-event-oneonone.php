                                    ...
                                    <div class="col-sm-12 col-xs-12 contact-block-inner">
                                        <div class="form-group col-md-6">
                                            <div class="col-md-6">
                                                ...
                                                <select name="event_duration" class="form-control" type="text"
                                                    autocomplete="off">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" name="event_custom_duration"
                                                    id="event_custom_duration"
                                                    value="<?php echo $event_custom_duration ?>">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <div class="col-md-6">
                                                <label class="control-label" for="event_max_book_per_day">Max number of
                                                    book per day</label>
                                            ...
                                            <div class="col-md-6">
                                                <label class="control-label" for="event_increment">Show availability in
                                                    increments of</label>
                                                <select name="event_increment" class="form-control" type="text"
                                                    autocomplete="off">
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="col-md-6">
                                                <label class="control-label" for="event_buffer_before">Buffer before
                                                    event</label>
                                                <select name="event_buffer_before" class="form-control" type="text"
                                                    autocomplete="off">
                                            ...
                                            <div class="col-md-6">
                                                <label class="control-label" for="event_buffer_after">Buffer after
                                                    event</label>
                                                <select name="event_buffer_after" class="form-control" type="text"
                                                    autocomplete="off">
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="create-event-form-col-1 col-md-4 form-item-top-padding-2">
                                                <label class="control-label" for="event_less_hour">Prevent events less
                                                    than</label>
                                            </div>
                                            <div class="create-event-form-col-1 col-md-4 form-item-top-padding-1">
                                                <input class="form-control" name="event_less_hour" id="event_less_hour"
                                                    value="<?php echo $event_less_hour ?>">
                                            </div>
                                            <div class="create-event-form-col-1 col-md-3 form-item-top-padding-2">
                                                <label class="control-label">hours away</label>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <div class="create-event-form-col-1 col-md-5 form-item-top-padding-2">
                                                <label class="control-label" for="event_rolling_week">Events can be
                                                    scheduled over</label>
                                            </div>
                                            <div class="create-event-form-col-1 col-md-3 form-item-top-padding-1">
                                                <input class="form-control" name="event_rolling_week"
                                                    id="event_rolling_week" value="<?php echo $event_rolling_week ?>">
                                            </div>
                                            <div class="create-event-form-col-1 col-md-3 form-item-top-padding-2">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-md-3 form-item-top-padding-1">
                                            <button type="submit" class="btn btn-secondary event-form-button"
                                                name="details_add_event_oneonone_availability">Add</button>
                                        </div>
                                    </div>
                                </form>
                ...
                ?>
                                <form action="controller_event.php" method="post">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-md-3 form-item-top-padding-1">
                                            <button type="submit" class="btn btn-secondary event-form-button"
                                                name="details_edit_event_oneonone_availability">Edit</button>
                                        </div>
                                        <div class="col-md-3 form-item-top-padding-1">
                                            <button type="submit" class="btn btn-secondary event-form-button"
