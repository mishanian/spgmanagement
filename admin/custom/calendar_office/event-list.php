...
<body>
    ...
    <section id="section-body">
        <div class="container">
            ...
            $office_calendar_url = "calendar.php?building_id=" . $building_id . "&event_category=office";
            $maintenance_calendar_url = "calendar.php?building_id=" . $building_id . "&event_category=maintenance";
            ?>
                        <div class="page-title-left">
                            <h2>Events | <a href="<?php echo $office_calendar_url; ?>">Office Calendar</a> | <a
                                    href="<?php echo $maintenance_calendar_url; ?>">Maintenance Calendar</a></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div id="content-area" class="contact-area">
                        <div class="white-block">
                            ...
                            <div class="row">
                                <legend>Regular Office Events | <a
                                        href="create-event.php?event_type=regular&event_category=office&building_id=<?php echo $building_id; ?>">Create</a>
                                </legend>
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-xs-3 text-center">Created By</th>
                    ...
                    //                $building_id = 1;
                    $results = $DB_event->get_events("regular", "office", $building_id);
                    ...
                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $event_created_by; ?></td>
                                            ...
                                            <form action="controller_event.php" method="post">
                                                <td class="text-center">
                                                    ...
                                                    <button type="submit" class="btn btn-secondary event-table-button"
                                                        name="details_event">Details</button>
                                                    <button type="submit" class="btn btn-secondary event-table-button"
                                                        name="delete_event"
                    ...
                    ?>
                            ...
                            <div class="row">
                                ...
                                <legend>Oncall Office Events | <a
                                        href="create-event.php?event_type=oncall&event_category=office&building_id=<?php echo $building_id; ?>">Create</a>
                                </legend>
                                <table class="table">
                                    <thead>
                                        <tr>
                    ...
                    $results = $DB_event->get_events("oncall", "office", $building_id);
                    foreach ($results as $row) {
                      $event_id = $row['id'];
                      $event_name = $row['event_name'];
                      $event_created_by = $row['event_created_by'];
                    ...
                    ?>
                            ...
                            <div class="row">
                                ...
                                <legend>Regular Maintenance Events | <a
                                        href="create-event.php?event_type=regular&event_category=maintenance&building_id=<?php echo $building_id; ?>">Create</a>
                                </legend>
                                <table class="table">
                                    <thead>
                                        <tr>
                    ...
                    $results = $DB_event->get_events("regular", "maintenance", $building_id);
                    foreach ($results as $row) {
                      $event_id = $row['id'];
                      $event_name = $row['event_name'];
                      $event_created_by = $row['event_created_by'];
                    ...
                    ?>
                            ...
                            <div class="row">
                                ...
                                <legend>Oncall Maintenance Events | <a
                                        href="create-event.php?event_type=oncall&event_category=maintenance&building_id=<?php echo $building_id; ?>">Create</a>
                                </legend>
                                <table class="table">
                                    <thead>
                                        <tr>
                    ...
                    $results = $DB_event->get_events("oncall", "maintenance", $building_id);
                    foreach ($results as $row) {
                      $event_id = $row['id'];
                      $event_name = $row['event_name'];
                      $event_created_by = $row['event_created_by'];
