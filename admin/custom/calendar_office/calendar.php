...
<body>
        ...
        <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            ...
                            <li><a id="a_event_list" href="event-list.php">Event List</a></li>
                            <li class="active">Office Calendar</li>
                        </ol>
            ...
            <div class="page-header">
                <div class="pull-right form-inline">
                    <div class="btn-group">
                        <button class="btn btn-secondary" data-calendar-nav="prev">
                            << Prev</button>
                                <button class="btn" data-calendar-nav="today">Today</button>
                                <button class="btn btn-secondary" data-calendar-nav="next">Next >></button>
                    </div>
                    <div class="btn-group">
                        <button class="btn btn-secondary" data-calendar-view="year">Year</button>
                        <button class="btn btn-secondary active" data-calendar-view="month">Month</button>
                        <button class="btn btn-secondary" data-calendar-view="week">Week</button>
                        <button class="btn btn-secondary" data-calendar-view="day">Day</button>
                    </div>
                </div>
                <h3></h3>
            </div>
    ...
    document.getElementById('a_event_list').setAttribute('href', 'event-list.php?&building_id=' + building_id);
    var event_category = getUrlParameter('event_category');
    var source = "calendar_event_source.php?building_id=" + building_id + "&event_category=" + event_category;
    var options = {
