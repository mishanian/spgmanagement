            ...
            <div class="row">
                ...
                ?>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th class="col-md-1 text-center">Booking ID</th>
                                            ...
                                            <th class="col-md-4 text-center">Comment</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                    ...
                    ?>
                                        ...
                                        <tr>
                                            <td class="text-center"><?php echo $booking_id; ?></td>
                                            <td class="text-center"><?php echo $booking_date; ?></td>
