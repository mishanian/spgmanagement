                        ...
                        <div class="l_payment">
                            ...
                            <div class="points" id="div_pay" style="overflow:scroll!important;">
                                <div class="table-responsive">
                                    <?php if ($payments) { ?>
                                    <form action="custom/checkout.php" method="post" id="payform"
                                        class="form_<?= $apartment_id ?>">
                                        ...
                                        <table class="table table-bordered" id="table_pay<?= $apartment_id ?>">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> N/A </td>
                                                    <td class="text_clr"><a
                                                            href="pay.php?id=<? echo  $payment['lease_payment_id']; ?>">pay</a>
                                                    </td>
                                                    <?php } ?>
                                                    <td>
                                                        <input class="selectPaymentrec"
                                                            ...
                                                            <?php echo $payment['outstanding'] <= 0 ? 'style="display:none;" ' : '' ?>
                                                            onclick="calc<?= $apartment_id . "_" . $lease_id ?>(<?= $payment['outstanding'] ?>, this.checked,this);">
                                                    </td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        <tr>
                                            ...
                                            <td><span
                                                    id="span_total_amount_<?= $apartment_id . "_" . $lease_id ?>">0</span>
                                                <input type="hidden" data-aptid="<?php echo $apartment_id; ?>" size="5"
                                                    id="total_amount_<?= $apartment_id . "_" . $lease_id ?>"
                                                    class="classtotal_payment_<?php echo $apartment_id; ?>"
                                                    name="total_payment" value="0">
                                                <input type="hidden" data-aptid="<?php echo $apartment_id; ?>" size="5"
                                                    id="pay_amount_<?= $apartment_id . "_" . $lease_id ?>"
                                                    name="payment_amount" value="0">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <input data-aptid="<?php echo $apartment_id; ?>" type="text" size="5"
                                                    ...
                                                    name="partial_pay_amount_<?= $apartment_id . "_" . $lease_id ?>"
                                                    disabled> $ CAD
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    function calc<?= $apartment_id . "_" . $lease_id ?>(os, isChecked, thisObject) {
                                        ...
                                        pay_amount = document.getElementById(
                                            "pay_amount_<?= $apartment_id . "_" . $lease_id ?>").value;
                                        if (isChecked == 1) {
                                        ...
                                        //var radios = document.getElementsByName("paymentType<? //=$apartment_id . "_" . $lease_id
                                        ?
                                        > //");
                                        ...
                                        $(".totalAmtDisplayWCf").each(function(i, v) {
                                            ...
                                            switch (typeOfPayment) {
                                                case "m1":
                                                    total_amount = total_amount + (parseFloat(total_amount) *
                                                        parseFloat(m1) / 100);
                                        ...
                                        document.getElementById(
                                                "span_total_amount_<?= $apartment_id . "_" . $lease_id ?>").innerHTML =
                                            totalAmtWoCf;
                                        document.getElementById("total_amount_<?= $apartment_id . "_" . $lease_id ?>")
                                            .value = totalAmtWoCf;
                                        $("#total_amount_<?= $apartment_id . "_" . $lease_id ?>").attr("value",
                                            totalAmtWoCf);
                                        $("#pay_amount_<?= $apartment_id . "_" . $lease_id ?>").attr("value",
                                            totalAmtWoCf);
                                        $("#partial_pay_amount_<?= $apartment_id . "_" . $lease_id ?>").val(
                                            totalAmtWoCf);
                                    }

                                    $('[name="if_partial_payment_<?= $apartment_id . "_" . $lease_id ?>"]').click(
                                        function() {
                                            var checked_value = $(
                                    ...
                                    $("body").on("blur", ".partial_payment_entry_amt", function(e) {
                                        ...
                                        var apt_id_current_tab = $(".aptsnavpills").children().filter(".active")
                                            .attr("data-aptid");
                                        ...
                                        if (apt_id_current_tab = apt_id) {
                                            ...
                                            if (amountEntered > parseFloat(total_payment)) {
                                                $(this).val(total_payment);
                                                $(".form_" + apt_id).find("input[name=total_payment]")
                                            }

                                            $(".classtotal_payment_" + apt_id).attr("value", amountEntered);
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <input id="<?php echo "paymentMethodIdForm_" . $apartment_id; ?>" type="hidden"
                                        ...
                                        <tr>
                                            ...
                                            <td><span data-aptid="<?php echo $apartment_id; ?>" data-ptype="m2"
                                                    data-cf="0" class="totalAmtDisplayWCf"
                                                    id="total_<?= $apartment_id . "-" . $lease_id ?>">0</span></td>
                                            <td><img align="center" src="custom/tenant_portal/images/interac3.png"
                                                    alt="pay_icon" height="30"
                                                    onclick="submitPayForm(<?php echo $apartment_id; ?>,'m2')"
                                    ...
                                    <div class="panel-group" id="accordion">
                                                ...
                                                <h5 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                        href="#collapseOne<?= $apartment_id . "-" . $lease_id ?>"><i
                                                            class="fa fa-circle" aria-hidden="true"></i>Building
                                                        Rules</a>
                                                </h5>
                                            </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" style="align-self: left">
                                                <h5 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                        href="#collapseTwo<?= $apartment_id . "-" . $lease_id ?>"><i
                                                            class="fa fa-circle" aria-hidden="true"></i>Building
                                                        Schedule</a>
                                                </h5>
                                            </div>
                                            <div id="collapseTwo<?= $apartment_id . "-" . $lease_id ?>"
                                                class="panel-collapse collapse ">
                                                <div class="panel-body " data-toggle="popover" data-trigger="hover"
                                                    title="<?= strip_tags($schedules_content) ?>">
                                                    <?
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h5 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                        href="#collapseThree<?= $apartment_id . "-" . $lease_id ?>"><i
                                                            class="fa fa-circle" aria-hidden="true"></i>Building
                                                        Document</a>
                                                </h5>
                                            </div>
                                            <div id="collapseThree<?= $apartment_id . "-" . $lease_id ?>"
                                                class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <p><a href="<?php echo "files/" . $building_document['building_file']; ?>"
                                                            download><?php echo $building_document['building_file_type']; ?></a>
                                                    </p>
                                                    <?php }
                                                    } ?>
                                                </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h5 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                        href="#collapseFour<?= $apartment_id . "-" . $lease_id ?>"><i
                                                            class="fa fa-circle" aria-hidden="true"></i>Apartment
                                                        Document</a>
                                                </h5>
                                            </div>
                                            <div id="collapseFour<?= $apartment_id . "-" . $lease_id ?>"
                                                class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <p><a href="<?php echo "files/" . $apartment_document['apartment_file']; ?>"
                                                            download><?php echo $apartment_document['apartment_file_type']; ?></a>
                                                    </p>
                                                    <?php }
                                                    } ?>
                                                </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h5class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                        href="#collapseFive<?= $apartment_id . "-" . $lease_id ?>"><i
                                                            class="fa fa-circle" aria-hidden="true"></i>Lease
                                                        Document</a>
                                                    </h4>
                                            </div>
                                            <div id="collapseFive<?= $apartment_id . "-" . $lease_id ?>"
                                                class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <p><a href="<?php echo "files/" . $lease_document['lease_file']; ?>"
                                                            download><?php echo $lease_document['lease_file_type']; ?></a>
                                                    </p>
                                                    <?php }
                                                    } ?>
                                                </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h5 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion"
                                                        href="#collapseSix<?= $apartment_id . "-" . $lease_id ?>"><i
                                                            class="fa fa-circle" aria-hidden="true"></i>Tenant
                                                        Document</a>
                                                </h5>
                                            </div>
                                            <div id="collapseSix<?= $apartment_id . "-" . $lease_id ?>"
                                                class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <p><a href="<?php echo "files/" . $tenant_document['tenant_file']; ?>"
                                                            download><?php echo $tenant_document['tenant_file_type']; ?></a>
                                                    </p>
                                                    <?php }
                                                    } ?>
                                                </div>
                        ...
                        <div class="bulletins">
                            <div class="headings_box">
                                <ul>
                                    ...
                                    <li class="pull-right"><span><b></b> <img
                                                src="custom/tenant_portal/images/bulletins_icon.png"
                                                alt="building_icon"></span></li>
                                    <div class="clearfix"></div>
                                </ul>
                            </div>
