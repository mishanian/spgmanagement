...
#use \Snapshot;
header("Location: apartmentinfoslist");
                ...
                <div class="row">
                            ...
                            <div class="points">
                                <ul>
                                    ...
                                    <li><a href="floor_infoslist.php">
                                            <p><i class="fa fa-building fa-3x"></i><?php echo $DB_snapshot->echot("Floors"); ?></p>
                                        </a></li>
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3">
                        ...
                        <div class="profile white-bkg">
                            <div class="headings_box">
                                <ul>
                                    <li class="pull-left"><?php echo $DB_snapshot->echot("Material & Maintenance"); ?></li>
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3">
                        <div class="scroll_menu white-bkg" id="request">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#unread_request"><?php echo $DB_snapshot->echot("Recent Requests"); ?></a></li>
                                            ...
                                            <li class="bg_li">
                                                <div class="container">
                                                    <ul class="row text-left">
                                                        <li class="col-xs-12">
                                                            <span style="text-decoration: underline"> <a href="<?php echo "requestadd?action=rview&rid=$request_id"; ?>"> <?php echo $unit_addr; ?> </a></span>
                                                            <span style="text-align:left"> [<?php echo $time_interval; ?>] </span>
                                                        </li>
