                ...
                <div class="points" id="div_total">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tr>
                                <td><input type="radio" name="if_partial_payment_<?= $apartment_id . "_" . $lease_id ?>"
                                        checked value="0"></td>
                            ...
                            <tr>
                                <td>
                                    <input type="radio" name="if_partial_payment_<?= $apartment_id . "_" . $lease_id ?>"
                                        value="1">
                                </td>
                                ...
                                <td>
                                    <input data-aptid="<?php echo $apartment_id; ?>" type="text" size="5"
                                        ...
                                        name="partial_pay_amount_<?= $apartment_id . "_" . $lease_id ?>" disabled> $ CAD
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="wrapper-tabscontent-main" style="display: none;">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><img align="center" src="custom/tenant_portal/images/interac3.png" alt="pay_icon"
                                        height="30" onclick="submitPayForm(<?php echo $apartment_id; ?>,'m2')"
                            ...
                            <tr>
                                ...
                                <td><span data-aptid="<?php echo $apartment_id; ?>" data-ptype="p1" data-cf="2.99"
                                        class="totalAmtDisplayWCf"
                                        id="total_<?= $apartment_id . "-" . $lease_id ?>">0</span></td>
                                <td><img align="center" src="custom/tenant_portal/images/paypal3.png" alt="pay_icon"
                                        height="30" onclick="submitPayForm(<?php echo $apartment_id; ?>,'p1')"
                                        style="cursor: pointer"></td>
                            </tr>
                            <tr>
                                ...
                                <td><img align="left" src="custom/tenant_portal/images/moneris3.png" alt="pay_icon"
                                        height="30" onclick="submitPayForm(<?php echo $apartment_id; ?>,'m1')"
                                        style="cursor: pointer"></td>
                            </tr>
                        </table>
                    </div>
        ...
        <div class="bldig_info">
            <div class="headings_box">
                <ul>
                    ...
                    <li class="pull-right"><span><b></b> <img src="custom/tenant_portal/images/building_info_icon.png"
                                alt="building_icon"></span></li>
                    <div class="clearfix"></div>
                </ul>
            </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseThree<?= $apartment_id . "-" . $lease_id ?>"
                                ...
                                <div class="panel-body">
                                    ...
                                    ?>
                                    <p>
                                        <a href="<?php echo "files/" . $building_document['building_file']; ?>"
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseFour<?= $apartment_id . "-" . $lease_id ?>"
                                ...
                                <div class="panel-body">
                                    ...
                                    ?>
                                    <p>
                                        <a href="<?php echo "files/" . $apartment_document['apartment_file']; ?>"
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseFive<?= $apartment_id . "-" . $lease_id ?>"
                                ...
                                <div class="panel-body">
                                    ...
                                    ?>
                                    <p>
                                        <a href="<?php echo "files/" . $lease_document['lease_file']; ?>"
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseSix<?= $apartment_id . "-" . $lease_id ?>" class="panel-collapse collapse">
                                <div class="panel-body">
                                    ...
                                    ?>
                                    <p>
                                        <a href="<?php echo "files/" . $tenant_document['tenant_file']; ?>"
        ...
        <div class="l_payment">
            ...
            <div class="headings_box">
                <ul>
                    ...
                    <li class="pull-right"><a href="requests.php?direct=report&unit_id=<?php echo $apartment_id; ?>">
        ...
        <div class="bulletins">
            <div class="headings_box">
                <ul>
                    ...
                    <li class="pull-right"><span><b></b> <img src="custom/tenant_portal/images/bulletins_icon.png"
                                alt="building_icon"></span></li>
                    <div class="clearfix"></div>
                </ul>
            </div>
