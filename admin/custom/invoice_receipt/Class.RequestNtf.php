...
class RequestNtf
{
  ...
  function __construct($request_id)
  {
    ...
    $this->building_pic = 'https://www.spgmanagement.com/admin/files/building_pictures/' . $record['building_pic'];
      ...
      <td>
        <table cellspacing="0" cellpadding="0" style="background-color:white;">
          ...
          <tr style="background-color:#E0F3FA;">
            <td align="center" style="text-align:center;padding:0; width: 600px;height: 25px;"><img src="https://www.spgmanagement.com/admin/phpimages/cityskyline.jpg" height="70"></td>
          </tr>
    ...
    <tr>
      <td>
        <table cellspacing="0" cellpadding="0" style="background-color:white;">
          ...
          <tr style="background-color:#E0F3FA;">
              <!-- Yuhong: changed height from 234px to 25px, changed image file and add image width-->
