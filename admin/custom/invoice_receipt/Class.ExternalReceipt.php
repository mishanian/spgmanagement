...
class ExternalReceipt
{
  ...
  public function __construct($lease_payment_details_id, $purchaser_email, $purchaser_name)
  {
  ...
  {
    $this->send_receipt_email($this->purchaser_email, $this->purchaser_name);
  }
  ...
  private function send_receipt_email($to_email, $to_name)
  {
    ...
    SendEmail('info@mgmgmt.ca', 'Info - spgmanagement.com', $to_email, $to_name, $email_sbj, $email_content);
  }
        ...
        <table cellspacing="0" cellpadding="0" style="background-color:white;">
          ...
          <tr style="background-color:white;">
            <td style="padding:30px 20px 20px 20px;">
              <div align="center" style="text-align:center;margin:40px 0 20px 0;"><font face="Arial,sans-serif" size="2" color="#3DA9F5" style="font-family: Arial, sans-serif, serif, EmojiFont;"><span style="font-size:15px;"><a href="https://www.spgmanagement.com/admin/custom/invoice_receipt/invoice_receipt_controller.php?download_receipt&lease_payment_details_id=' . $this->lease_payment_details_id . '" target="_blank" rel="noopener noreferrer" style="text-decoration:none;"><font color="white"><span style="background-color:#80C246;padding:15px 45px;"><b>Download Receipt</b></span></font></a></span></font></div>
            </td>
          </tr>
