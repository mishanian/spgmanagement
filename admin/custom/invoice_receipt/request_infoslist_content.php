...
<div id="container">
  <div class="col-xs-12 col-md-4 report-btn" style="margin-left: 0px;">
    <button id="startReport" class="btn btn-primary <?php echo $allow_create_request == 0 ? 'remove-for-tenant':''; ?>" data-toggle="modal" data-target="#reportModal">Report an Request</button>
    <button id="startBulletin" class="btn btn-primary remove-for-tenant" data-toggle="modal" data-target="#newBulletinModal">New Notification</button>
  </div>

  <div class="hidden-xs col-md-6" style="margin-top: 10px;">
    <div class="col-md-4 remove-for-tenant"><div class="category-box category-internal"></div><div class="box-text">Internal Request</div></div>
    <div class="col-md-4 remove-for-tenant"><div class="category-box category-tenant"></div><div class="box-text">Tenant Request</div></div>
    <div class="col-md-4" id="unread_request_mark"><div class="category-box category-unread"></div><div class="box-text">Unread Request</div></div>
  </div>

  <div class="hidden-xs col-md-2">
    <div class="box-text"><span id="open_issue_count">OPEN REQUESTS: <?=$open_issue_counter?></span><br>UNREAD:<span id="unread_issue_count"><?=$unread_issue_count?></span></div>
  </div>

  <div class="col-md-12" style="padding-top: 20px;">
    <ul class="nav nav-tabs" role="tablist">
      <li role="presentation" class="active"><a href="#current-issues" aria-controls="current-issues" role="tab" data-toggle="tab">Current Requests</a></li>
      <li role="presentation" class=" <?php echo $view_past_request == 0 ? 'remove-for-tenant':'';?> "><a href="#past-issues" aria-controls="past-issues" role="tab" data-toggle="tab">Past Requests</a></li>
      <li role="presentation"><a href="#bulletin" aria-controls="bulletin" role="tab" data-toggle="tab">Bulletins</a></li>
    </ul>
  </div>
  ...
  <div class="tab-content">
    <div role="tabpanel" class="tab-pane active row" id="current-issues">
      <div id="filter-part-current" class="col-sm-12 col-md-12" style="padding: 15px 0;">
        ...
        <div class="col-sm-4 col-md-3 filter-block col-sm-off-8 col-md-offset-6" style="padding-top: 5px;">
          <button class="btn btn-primary col-sm-4 col-md-4 col-sm-offset-2 col-md-offset-2" id="default_current">Clear</button>
          <button class="btn btn-primary col-sm-4 col-md-4 col-sm-offset-1 col-md-offset-1" id="search_current">Search</button>
        </div>
              ...
              foreach ($current_issues as $row){
                  ...
                  if(strtotime($last_access_time) < strtotime($last_update_time))
                    $style_class = 'danger';
                      ...
                      $style_class = 'warning';
              ?>
                <tr class="<?php echo $style_class;?> issue-line" id="<?php echo 'issue_row_'.$request_id;?>" data-toggle="" data-target="#iModal" data-request="<?php echo $request_id;?>">
                  ...
                  <td class="col-md-1 text-center <?php echo $level_label_class;?>"><?php echo $request_level;?></td>
                  <td class="col-md-2 text-center"><?php echo $created_time;?></td>
                  <td class="col-md-1 text-center"><?php echo $interval;?></td>
                  <td class="col-md-1 text-center non-overflow"  data-toggle="tooltip" data-container="body" title="<?php echo " Telephone : ".$created_user_info['mobile']." Email : ".$created_user_info['email'];?>"><?php echo $created_user_info['full_name'];?></td>
                  <td class="col-md-2 text-center non-overflow"  data-toggle="tooltip" data-container="body" title="<?php echo $address;?>"><?php echo $address;?></td>
    ...
    <div role="tabpanel" class="tab-pane remove-for-tenant row" id="past-issues">
      <div id="filter-part" class="col-sm-12 col-md-12" style="padding: 15px 0;">
        ...
        <div class="col-sm-4 col-md-3 filter-block col-sm-off-8 col-md-offset-6" style="padding-top: 5px;">
          <button class="btn btn-primary col-sm-4 col-md-4 col-sm-offset-2 col-md-offset-2" id="default_past">Clear</button>
          <button class="btn btn-primary col-sm-4 col-md-4 col-sm-offset-1 col-md-offset-1" id="search_past">Search</button>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-title" id="iModalLabel"><div class="modal-h-id"><i>Requests #: </i><span id="issue_id"></span><span id="issue_h_type"></span></div></div>
        <div class="modal-status modal-status-open" id="open_or_closed"><span class="main-status" id="open_or_closed_text">OPEN</span></div>
      ...
      <div class="modal-body" style="padding: 10px 16px">
        ...
        <ul class="nav nav-tabs" role="tablist" style="margin-top: 10px;">
          <li role="presentation" class="active"><a id="communication_tag" href="#communication" aria-controls="communication" role="tab" data-toggle="tab">Communications</a></li>
          <li role="presentation"><a id="attach_tag" href="#attach" aria-controls="attach" role="tab" data-toggle="tab">Attachments</a></li>
          <li role="presentation"><a id="recipient_tag" href="#recipient" aria-controls="recipient" role="tab" data-toggle="tab">Recipient</a></li>
          <li role="presentation"><a id="edit_tag" href="#edit" aria-controls="edit" role="tab" data-toggle="tab">Editing</a></li>
        </ul>
            ...
            <div class="communication-div">
              ...
              <div class="row">
                <div id="new_message" class="col-sm-12 form-group">
                  <label></label>
                  <textarea class="form-control" id="communication_text" name="message" placeholder="Communicaiton Messgae"></textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-12 form-group" id="opeartions_new_message">
                  <div class="col-sm-12">
                    <button type="button" class="btn btn-primary btn-post" id="post_communication" onclick="add_communication()">Post</button>
                    <div class="checkbox remove-for-tenant modal-communication-selection"><label><input type="checkbox" id="hide_for_tenant">Hidden for tenants</label></div>
                    <div class="checkbox remove-for-tenant modal-communication-selection"><label><input type="checkbox" id="force_ntf" >Notify recipients</label></div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-4">
                          <button id="saveRecipients" type="submit" class="btn btn-primary">Save</button>
                          <button id="cancelRecipients" type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="form">
                <form id="edit-request">
                    ...
                    <div class="col-sm-12 request-location-wrap">
                      <div class="form-group">
                        ...
                        <div class="col-sm-8 col-md-8 request-location-div">
                          <input class="edit-input form-control" id="location" name="location">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label class="edit-label col-sm-4 col-md-3" for="request-type">Request Type</label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8 col-md-8 request-approve-div">
                          <label class="radio-inline">
                            <input class="edit-input request-visit-approved" type="radio" name="approved" value="1" checked>Yes
                          </label>
                          <label class="radio-inline">
                            <input class="edit-input request-visit-not-approved" type="radio" name="approved" value="0">No
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12 request-visit-time-wraps">
                      <div class="form-group">
                        ...
                        <div class="col-sm-8 col-md-8 request-time-div">
                          ...
                          <div class="time-note">Note: Please be prepared for at least 4 hours of visit for our handyman to work on this request.</div>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8 col-md-8">
                          <label class="btn btn-primary btn-file">
                            Select Images<input class="request-pic-upload" type="file" name="pictures[]" style="display: none">
                          </label>
                  ...
                  <div class="row">
                    <div class="col-sm-12 request-notify-me-wrap">
                      <div class="form-group">
                        <label class="edit-label col-sm-4 col-md-3 request-notify-label" id="notifyLabel">Notify Me by</label>
                        <div class="col-sm-8 col-md-8">
                          <label class="checkbox-inline"><input type="hidden" name="notifyMeByEmail" value="0"><input class="edit-input notify-me-by-email" type="checkbox" name="notifyMeByEmail" id="editNotifyMeEmail" value="1">Email</label>
                          <label class="checkbox-inline"><input type="hidden" name="notifyMeBySms" value="0"><input class="edit-input notify-me-by-sms" type="checkbox" name="notifyMeBySms" id="editNotifyMeSms" value="1">SMS</label>
                          <label class="checkbox-inline"><input type="hidden" name="notifyMeByVoice" value="0"><input class="edit-input notify-me-by-voice" type="checkbox" name="notifyMeByVoice" id="editNotifyMeVoice" value="1">Voice</label>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-4">
                          ...
                          <button type="button" class="btn btn-default" data-dismiss="modal" id="cancelEdit">Cancel</button>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <form id="reportIssue" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-sm-12" id="requestTypeWrap">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8 col-md-8">
                      <label class="radio-inline">
                        <input id="report-visitApproved" class="edit-input request-visit-approved" type="radio" name="reportApprovedVisit" value="1" checked>Yes
                      </label>
                      <label class="radio-inline">
                        <input id="report-visitNotApproved" class="edit-input request-visit-not-approved" type="radio" name="reportApprovedVisit" value="0">No
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-sm-12 request-visit-time-wraps" id="visitFromWrap">
                  <div class="form-group">
                    <label class="edit-label col-sm-4 col-md-3" for="visitFrom">Visit Time</label>
                    <div class="col-sm-8 col-md-8">
                      <input class="edit-input form-control" type="time" name="reportVisitFrom" id="report-visitFrom" value="09:00:00">
                      <div class="time-note">Note: Please be prepared for at least 4 hours of visit for our handyman to work on this request.</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8 col-md-8" id="reportPicturesWrap">
                      <label class="btn btn-primary btn-file">Select Images<input class="request-pic-upload" id="reportButton" type="file" name="file[]" style="display: none" accept="image/*" multiple></label>
              ...
              <div class="row">
                <div class="col-sm-12 request-status-wrap" id="report-status">
                  <div class="form-group">
                    <label class="edit-label col-sm-4 col-md-3">Status</label>
                    <div class="col-sm-8 col-md-8">
                      <select class="edit-select form-control request-status" id="report-request-status" name="reportRequestStatus" title="Status">
                        <option value="0">null</option>
                      </select>
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-sm-12 request-notify-me-wrap">
                  <div class="form-group">
                    <label class="edit-label col-sm-4 col-md-3 request-notify-label" id="notifyLabel">Notify Me by</label>
                    <div class="col-sm-8 col-md-8">
                      <label class="checkbox-inline"><input type="hidden" name="notifyMeByEmail" value="0"><input class="edit-input notify-me-by-email" type="checkbox" name="notifyMeByEmail" id="reportNotifyMeEmail" value="1">Email</label>
                      <label class="checkbox-inline"><input type="hidden" name="notifyMeBySms" value="0"><input class="edit-input notify-me-by-sms" type="checkbox" name="notifyMeBySms" id="reportNotifyMeSms" value="1">SMS</label>
                      <label class="checkbox-inline"><input type="hidden" name="notifyMeByVoice" value="0"><input class="edit-input notify-me-by-voice" type="checkbox" name="notifyMeByVoice" id="reportNotifyMeVoice" value="1">Voice</label>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    <div class="col-sm-8 col-sm-offset-4">
                      <button type="button" class="btn btn-primary" id="submitReport">Report this request</button>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-title"><div class="modal-h-id"><i>Notification #: </i><span id="bulletin_shown_id"></span></div></div>
        <div class="modal-created-by-info">
      ...
      <div class="modal-body">
        ...
        <ul class="nav nav-tabs" role="tablist" style="margin-top: 10px;">
          <li role="presentation" class="active"><a id="bulletin_content_tag" href="#bulletin_content" role="tab" aria-controls="bulletin_content" data-toggle="tab">Details</a></li>
          <li role="presentation" class="remove-for-tenant"><a id="bullentin_read_status_tag" href="#bulletin_read_status" role="tab" data-toggle="tab">Read Tenants</a></li>
        </ul>
            ...
            <form id="bulletinForm">
              ...
              <div class="row">
                <div class="col-sm-12 form-group">
                  ...
                  <div class="col-sm-8 col-md-8">
                    <input class="form-control" id="bulletinFrom" type="date" name="bulletinFrom" required>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-12 form-group">
                  ...
                  <div class="col-sm-8 col-md-8">
                    <input class="form-control" id="bulletinTo" type="date" name="bulletinTo" required>
                  </div>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-sm-12 form-group">
                  <div class="col-sm-8 col-sm-offset-4">
                    <button type="submit" class="btn btn-primary" id="submitNewBulletin">Submit</button>
                    <button class="btn btn-default" data-dismiss="modal">Cancel</button>
                  </div>
                </div>
              </div>
...
//-----------------  communications -------------------
  ...
  function init_communications(request_id){
   ...
   function set_communications_view(data){
       ...
       for (var i in data){
           ...
           $('#communications').append('<div class="message-container '+ bg_color +'">\n' +
               ...
               '                    <a id="read_status_'+i+'" class="message-info-read-status" tabindex="0" role="button" data-toggle="popover" data-container="body" data-trigger="focus">Reading status</a>\n' +
           ...
           for (r in assignees_status) {
               if (assignees_status[r].read_status == 'read')
                   var temp ='<button type="button" class="btn btn-primary read-status-bk" data-toggle="tooltip" data-placement="right" title="last access: '+ assignees_status[r].last_access_time +'">' + assignees_status[r].user_name + '</button>';
               else if(assignees_status[r].read_status == 'unread')
                   var temp = '<button type="button" class="btn btn-warning read-status-bk" data-toggle="tooltip"  data-placement="right" title="last access: '+ assignees_status[r].last_access_time +'">' + assignees_status[r].user_name + '</button>';
           ...
           text = text + '<div><h6> Legend: </h6> Read: <button type="button" class = "btn btn-primary"> &nbsp; &nbsp;  </button> '+
   ...
   function set_attachments_view(data) {
       $('#attach_images').empty();
       for (index in data) {
           $('#attach_images').append('<a class="attach-a" href="' + data[index] + '" data-lightbox="attach-img" data-title="Picture Title"><img src="' + data[index] + '" href="#"></a>');
       }
   }
...
function init_request(formId){
    ...
    function set_building_view(data,area,formId){
        ...
        if (area == 'common area'){
            var content = '<select class="edit-input form-control request-location-building report-location-margin-top" id="reportBuilding" name="reportBuildingId" required><option value="">Select Building ...</option>';
            for (var i in data) {
            ...
            $(formId+' .request-location-building').on('change',function () {
                $(this).nextAll().remove();
                $(formId+' .request-location-div').append('<textarea class="form-control report-location-margin-top" id="reportAreaDetails" name="reportLocationDetails" rows="5" placeholder="Specific Common Area (e.g. Elevator No.2)" ></textarea>');
            });
    ...
    function set_report_floor_view(data,formId){
        ...
        $(formId+' .request-tenant-wrap').remove();
        $(formId+' .request-notify-wrap').remove();
        var content = '<select class="edit-input form-control request-location-floor report-location-margin-top" id="reportFloorEdit" name="reportFloorId" required><option value="">Select Floor ...</option>';
        for (var i in data){
    ...
    function set_report_apartment_view(data,formId){
        ...
        $(formId+' .request-tenant-wrap').remove();
        $(formId+' .request-notify-wrap').remove();
        var content = '<select class="edit-input form-control request-location-apartment report-location-margin-top" id="reportApartment" name="reportApartmentId" required><option value="">Select Unit Number ...</option>';
        for(var i in data){
    ...
    function set_report_tenant_view(data,formId){
        ...
        var content = '<div class="col-sm-12 request-tenant-wrap" id="reportTenantsWrap"><div class="form-group"><label class="edit-label col-sm-4" for="reportTenants">Include Tenants as Recipients</label><div id="reportTenants" class="col-sm-8"><table>';
        for(var i in data){
            content += '<tr><td><label class="checkbox-inline"><input class="edit-input" type="checkbox" name="reportTenantIds[]" value="'+data[i].tenant_id+'" checked>'+data[i].tenant_name+'</label></td></tr>';
        }
  ...
  function set_editing_view(formId,data) {
      if (user_level == 5){
          ...
          if (data.location === 'apartment') {
              ...
              $(formId + ' .request-location-div').empty();
              $(formId + ' .request-location-div').append('The common area('+data.common_area_detail+') in '+data.building_name);
...
function submit_edit(request_id) {
  ...
  function update_current_issue_page(data,page_number){
      ...
      for(i in data_arr){
         ...
         $('#current_issue_tbody').append('<tr class="'+ data_arr[i].style_class + ' issue-line" id="' + id + '" data-toggle="modal" data-target="#iModal" data-request="' + data_arr[i].request_id + '">\n'+
'              <td class="col-md-1 text-center">'+ data_arr[i].issue_status +'</td>\n' +
'              <td class="col-md-2 text-center">'+ data_arr[i].request_type +'</td>\n' +
'              <td class="col-md-1 text-center ' + level_label_class + '">'+ data_arr[i].request_level +'</td>\n' +
'              <td class="col-md-2 text-center">'+ data_arr[i].created_time +'</td>\n' +
'              <td class="col-md-1 text-center">'+ data_arr[i].interval +'</td>\n' +
'              <td class="col-md-1 text-center non-overflow"  data-toggle="tooltip" data-container="body" title="'+ persson_info +'">'+ data_arr[i].creator_full_name +'</td>\n' +
'              <td class="col-md-2 text-center non-overflow"  data-toggle="tooltip" data-container="body" title="'+ data_arr[i].address+'">'+ data_arr[i].address +'</td>\n' +
'              <td class="col-md-2 text-center non-overflow"  data-toggle="tooltip" data-container="body" title="'+ data_arr[i].message +'">'+ data_arr[i].message +'</td>\n' +
'            </tr>');
      }
  ...
  function update_past_issue_page(data,page_number){
      ...
      for(i in data_arr){
          ...
          $('#past_issues_tbody').append('<tr class="'+ data_arr[i].style_class + ' issue-line" id="' + id + '" data-toggle="modal" data-target="#iModal" data-request="' + data_arr[i].request_id + '">\n'+
              ...
              '              <td class="col-md-1 text-center non-overflow"  data-toggle="tooltip" data-container="body" title="'+ persson_info +'">'+ data_arr[i].creator_full_name +'</td>\n' +
              '              <td class="col-md-2 text-center non-overflow"  data-toggle="tooltip" data-container="body" title="'+ data_arr[i].address+'">'+ data_arr[i].address +'</td>\n' +
              '              <td class="col-md-3 text-center non-overflow"  data-toggle="tooltip" data-container="body" title="'+ data_arr[i].message +'">'+ data_arr[i].message +'</td>\n' +
              '            </tr>');
      }
  ...
  function set_filter_units_current(data) {
      ...
      for(i in data_conent){
          $('#filter_units_current').append('<option id="' + data_conent[i].apartment_id + '">' + data_conent[i].unit_number + '</option>');
      }
  }
  ...
  function set_filter_units_past(data) {
      ...
      for(i in data_conent){
          $('#filter_units_past').append('<option id="' + data_conent[i].apartment_id + '">' + data_conent[i].unit_number + '</option>');
      }
  }
