	...
	if ($_POST['gateway'] == 'm1') {
        ...
        <div class="col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-2"
            ...
            <div class="col-sm-6 col" style="text-align: right;">
                ...
                <dl style="margin-bottom: 5px"><?php echo '$' . number_format(round($real_pay_amount, 2), 2) . ' CAD'; ?></dl>
                <dl style="margin-bottom: 5px"><?php echo '$' . number_format(round($convenience_fee, 2), 2) . ' CAD'; ?></dl>
                <dl style="margin-bottom: 5px"><?php echo '$' . number_format(round($transaction_amount, 2), 2) . ' CAD'; ?></dl>
