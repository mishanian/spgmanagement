...
foreach ($a as $zone_name=>$zone_code){

    $zone_diff=substr($zone_name,4,6);
//echo "$zone_diff $zone_code=$zone_name<br>";
    $zone_name=str_replace("(","\(", $zone_name);
    $zone_name=str_replace(")","\)",$zone_name);
    $EmpSql = "insert into timezones (zone_diff,zone_code,zone_name) VALUES ('$zone_diff','$zone_code','$zone_name')";
    echo $EmpSql;
