    ...
    <div class="houzez-taber-body no_marpad_top">
        <div class="tab-content">
            ...
            foreach ($apt_rows as $apt_row) {
                /*
                if (in_array($apt_row, [646, 397, 654])) {
                    continue;
                } // test to remove units that makes issue , always should be commented
                */
                $apt_counter++;
                if ($DB_apt->isUnitShowed($apt_row['apartment_id'])) {
                    ...
                    $apt_real_counter++;
            ?>
            <div id="<?php echo "tabcontent_" . $apt_row["apartment_id"] ?>" class="tab-pane fade <?php if ($default == '0') {
                                                                                                                echo "active in";
                                                                                                                $default = '1';
                                                                                                            } ?>">
                <div class="row">
                                ...
                                <div class="row ">
                                    <div class="prop_details">
                                        ...
                                        <div class="col-lg-6">
                                            <a href="book-event.php?building_id=<?php echo $building_id; ?>&apt_id=<?php echo $apt_id; ?>"
                                                style="margin:5px"
                                                class="btn btn-success btn-sm"><?php echo $DB_snapshot->echot("Visit Appointment"); ?>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="row ">
                                    ...
                                    <div class="row ">
                                        <div class="col-lg-12">
                                            ...
                                            <? if ($isMobile && $apt_row['floor_plan']) {
                                    ...
                                    <div class="row">
                                        <div class="col-*-12 text-center">
                                            <? if($apt_real_counter!=0){?><button class="btn btn-lg prev_row"
                                                style="background-color:#0d47a1; color:blanchedalmond"> &lt; Previous
                                                Unit</button>
                                            <? }?>

                                            <? if($apt_counter!=$apt_count){?><button class="btn btn-lg next_row"
                                                style="background-color:#0d47a1; color:blanchedalmond"> Next Unit &gt;
                                            </button>
                                            <? }?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="detail-title">
                                        <h2 class="title-left">
                                            <?php echo $DB_snapshot->echot("Unit Description");
                                                    ?></h2>
                                    </div>
                                    <div>
                                        <p><?php echo $apt_row['public_comments'];
                                                    ?></p>
                                    </div>
