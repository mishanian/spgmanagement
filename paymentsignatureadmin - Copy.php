...
if(!empty($attach)) {
echo "<br><span><a target='_blank' href='https://ilivein.xyz/admin/files/$attach'>";
}
echo $invoice_no."</a>";
...
?>
                            <? if(!empty($reason)){?>Reason to reset : <b><?=$reason?></b><? }?>
                                ...
                                if(!empty($invoice_id)) {
                                    ...
                                    //	var_dump($attach);
                                    if(!empty($attach)) {
                                        echo "<br><span><a target='_blank' href='https://ilivein.xyz/admin/files/$attach'>Click to download invoice Attachment</a></span>";
                                    }
                                }
                                ?>
                            </div>
