<!-- <div class="detail-title">
    <h2 class="title-left"><?php echo $DB_snapshot->echot("Unit Pictures"); ?></h2>
</div> -->
<?php
if ($apt_row['pictures']) {
?>
                ...
                <div class="post-card-item" style="padding: 0px">
                    <div class="figure-block">
                        <figure class="item-thumb">
                            <a href="<?php echo "admin/files/$apt_pic"; ?>" class="hover-effect"
                                data-gal="prettyPhoto[gallery<?=$apt_row['apartment_id']?>]">
                                <div class="unitPictures">
                                    <img alt="Unit Picture" class="unitPictures" src="<?php echo "admin/files/$apt_pic" ?>"
                                        style="height: 120px;">
                                </div>
                            </a>
                        </figure>
...
src="https://www.youtube.com/embed/<?=$apt_row['video']?>">
</iframe>
</div>
<? }?>
</div></div>